...
public class InventoryItems {
	...
	private double quantity; // changed in 19th April 2018
	private String unit;
	//private float rate;
	private double rate; // changed in 19th April 2018
	...
	private double dailyRequirement; // changed in 19th April 2018
	...
	private String isStockable; // new added in 20.7.2018
  ...
  public String toString() {
    return "InventoryItems [id=" + id + ", code=" + code + ", name=" + name + ", quantity=" + quantity + ", unit="
        + unit + ", rate=" + rate + ", barcode=" + barcode + ", deleteFlag=" + deleteFlag + ", createdBy=" + createdBy
        + ", createdDate=" + createdDate + ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate + ", vendorId="
        + vendorId + ", storeId=" + storeId + ", vendorName=" + vendorName + ", shippingCharge=" + shippingCharge
        + ", dailyRequirement=" + dailyRequirement + ", inventoryType=" + inventoryType + ", metricUnitId="
        + metricUnitId + ", tax=" + tax + ", stockAvailable=" + stockAvailable + ", isTaxExclusive=" + isTaxExclusive
