...
public class MenuItems implements Serializable {
  ...
  public String toString() {
    return "MenuItems [id=" + id + ", name=" + name + ", description=" + description + ", price=" + price
        ...
        + ", houseSpecial=" + houseSpecial + ", vat=" + vat + ", serviceTax=" + serviceTax + ", menucatId=" + menucatId
        + ", menucatName=" + menucatName + ", submenucatId=" + submenucatId + ", submenucatName=" + submenucatName
        + ", code=" + code + ", dailyMinQty=" + dailyMinQty + ", unit=" + unit + ", packaged=" + packaged
        + ", production=" + production + ", cookingTimeInMins=" + cookingTimeInMins + ", specialNote=" + specialNote
        + ", printerList=" + printerList + ", spotDiscount=" + spotDiscount + ", bgColor=" + bgColor + ", currentStock="
        + currentStock + ", isKotPrint=" + isKotPrint + ", purchasePrice=" + purchasePrice + "]";
  }
