...
public class DeliveryBoyService {
	...
	public String editDeliveryBoy(DeliveryBoy deliveryBoyObj)
	{
		try{
			...
			logger.debug("url....{}",url);
			System.out.println(gson.toJson(deliveryBoyObj));
			ClientResponse response=WebServiceClient.callPost(url, gson.toJson(deliveryBoyObj));
			String responseString=response.getEntity(String.class);
			logger.debug("response string...{}",responseString);
			return responseString;
	...
	{
		try{
			String url=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_DELVRYBOYMGNT_ASSIGNDELIVERYBOY);
			logger.debug("url....{}",url);
			System.out.println(gson.toJson(deliveryBoyObj));
			ClientResponse response=WebServiceClient.callPost(url, gson.toJson(deliveryBoyObj));
			String responseString=response.getEntity(String.class);
