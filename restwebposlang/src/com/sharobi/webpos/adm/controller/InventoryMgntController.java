...
public class InventoryMgntController {
	...
	@RequestMapping(value = "/loadinvtypemgnt",
	...
	@RequestMapping(value = "/addinvtype",
					method = RequestMethod.POST)
	public void addMenuCategory(@RequestBody String invTypeadd,
								HttpSession session,
	...
	@RequestMapping(value = "/editinvtype",
					method = RequestMethod.POST)
	public void editInvType(@RequestBody String invtypeedit,
								HttpSession session,
								HttpServletResponse response) throws IOException {
	...
	@RequestMapping(value = "/deleteinvtype/{id}",
					method = RequestMethod.GET)
	...
	@RequestMapping(value = "/loadinvitemmgnt",
					method = RequestMethod.GET)
	...
	@RequestMapping(value = "/loadsimpleinvitemmgnt",
					method = RequestMethod.GET)
	...
	@RequestMapping(value = "/addinvitem",
					method = RequestMethod.POST)
	public void addInvItem(	@RequestBody String invItemAddPost,
							HttpSession session,
							HttpServletResponse response) throws IOException {
	...
	@RequestMapping(value = "/editinvitem",
					method = RequestMethod.POST)
	public void editInvItem(@RequestBody String invItemEditPost,
							HttpSession session,
							HttpServletResponse response) throws IOException {
		...
		if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) != null) {
			...
			/*InvType invType = new InvType();
			invType.setId(NumberUtils.toInt(itemtype));
			...
			inventoryItem.setRate(NumberUtils.toDouble(rate));
			String unitname = "";
			MetricUnit metricUnit = inventorymgntService.getInvItemUnitDetails(Integer.valueOf(unit));
			unitname = metricUnit.getUnit();
			System.out.println("unitname=" + unitname);
			inventoryItem.setUnit(unitname);
	...
	@RequestMapping(value = "/deleteinvitem/{id}",
					method = RequestMethod.GET)
	public void deleteInvItem(	@PathVariable("id") String id,
								HttpSession session,
								HttpServletResponse response) throws IOException {
	...
	@RequestMapping(value = "/autocomplete",
					method = RequestMethod.GET)
	public List<InventoryItem> getAutocompleteList(	@RequestParam String tagName,
													HttpSession session,
													HttpServletResponse response) throws IOException {
	...
	@RequestMapping(value = "/loadinvitemsbyid",
					method = RequestMethod.GET)
	public ModelAndView loadInvItemsById(	@RequestParam int invitemid,
											HttpSession session) {
	...
	@RequestMapping(value = "/loadsimpleinvitemsbyid",
					method = RequestMethod.GET)
	public ModelAndView loadSimpleInvItemsById(	@RequestParam int invitemid,
												HttpSession session) {
		logger.debug("in loadinvitemsbyid...! ");
		ModelAndView mav = new ModelAndView();
		Customer customer = null;
