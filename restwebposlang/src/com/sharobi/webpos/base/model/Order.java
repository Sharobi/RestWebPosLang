...
public class Order implements Serializable{
    ...
    private String time;
    private String refundStatus; //new added for Order Refund 13th June 2018
    private int billPrintcount;//new added for  26th June 2018
  ...
  public String toString() {
    return "Order [id=" + id + ", customerId=" + customerId + ", customerName=" + customerName + ", customerContact="
        + customerContact + ", orderDate=" + orderDate + ", orderDateNew=" + orderDateNew + ", deliveryAddress="
        + deliveryAddress + ", deliveryPersonName=" + deliveryPersonName + ", activationFlag=" + activationFlag
        + ", storeId=" + storeId + ", table_no=" + table_no + ", distance=" + distance + ", specialNote=" + specialNote
        + ", orderTime=" + orderTime + ", billReqStatus=" + billReqStatus + ", billReqTime=" + billReqTime
        + ", changeNote=" + changeNote + ", cancelFlag=" + cancelFlag + ", loginCustomerId=" + loginCustomerId
        + ", loginCustomerName=" + loginCustomerName + ", paymentTypeId=" + paymentTypeId + ", paymentTypeName="
        + paymentTypeName + ", ordertype=" + ordertype + ", paymentId=" + paymentId + ", paymentAmount=" + paymentAmount
        ...
        + ", paidAmt=" + paidAmt + ", childTables=" + childTables + ", seatNo=" + seatNo + ", printerId=" + printerId
        + ", storeCustomerId=" + storeCustomerId + ", creditFlag=" + creditFlag + ", source=" + source
        + ", cancelRemark=" + cancelRemark + ", custVatRegNo=" + custVatRegNo + ", location=" + location + ", houseNo="
        + houseNo + ", street=" + street + ", dob=" + dob + ", anniversary=" + anniversary + ", waiterName="
        + waiterName + ", state=" + state + ", time=" + time + ", refundStatus=" + refundStatus + ", billPrintcount="
        + billPrintcount + ", orderNo=" + orderNo + ", payments=" + payments + "]";
  }
