...
public class Store implements Serializable {
	...
	private String specialNoteType;
    ...
    private String isProvideReason; // new added 21st feb 2018
    private String smsIntegration; // new added 29th march 2018

    private int billCount; // new added 22th May 2018

    private String simpleIm; // new added 28th May 2018  flag for normal  Inventory
    private String roomBooking; // new added 28th May 2018 flag for room booking
    private String ordSucc; // new added 28th May 2018 flag for Order success pop-up in order-taking page
    private String  smartIm; // new added 28th May 2018 flag for recipe based Inventory
    private String isRefund; // new added 13th June for Order Refund
    private String is_account; //new added for account module
    private String advOrder;
    
    //private String is_additem;//for add item from table page 5th oct 2018
 ...
 public String getIs_account() {
  ...
  public String toString() {
    return "Store [id=" + id + ", ip=" + ip + ", latitude=" + latitude + ", longitude=" + longitude + ", storeName="
        + storeName + ", chainName=" + chainName + ", nameSearch=" + nameSearch + ", detailsSearch=" + detailsSearch
        + ", address=" + address + ", phoneNo=" + phoneNo + ", mobileNo=" + mobileNo + ", emailId=" + emailId
        + ", status=" + status + ", city=" + city + ", state=" + state + ", country=" + country + ", category="
        + category + ", url=" + url + ", operatingSystem=" + operatingSystem + ", ram=" + ram + ", currency=" + currency
        + ", activeFlag=" + activeFlag + ", restaurantId=" + restaurantId + ", quality=" + quality + ", openTime="
        + openTime + ", closeTime=" + closeTime + ", deliveryTime=" + deliveryTime + ", workingHours=" + workingHours
        + ", minOrderAmt=" + minOrderAmt + ", freeDelivery=" + freeDelivery + ", license=" + license
        + ", promotionDesc=" + promotionDesc + ", promotionValue=" + promotionValue + ", promotionFlag=" + promotionFlag
        + ", openTimeWeekend=" + openTimeWeekend + ", closeTimeWeekend=" + closeTimeWeekend + ", openTimeHoliday="
        + openTimeHoliday + ", closeTimeHoliday=" + closeTimeHoliday + ", tableFlag=" + tableFlag + ", parcelFlag="
        + parcelFlag + ", homeDeliveryFlag=" + homeDeliveryFlag + ", dataSource=" + dataSource + ", mpayment="
        + mpayment + ", kitchenPrint=" + kitchenPrint + ", kitchenPrintPreview=" + kitchenPrintPreview
        ...
        + kotResTitleFont + ", kotTextFont=" + kotTextFont + ", kotDateTimeFont=" + kotDateTimeFont + ", kotTableFont="
        + kotTableFont + ", kotItemTitleFont=" + kotItemTitleFont + ", kotItemFont=" + kotItemFont
        + ", kotNoOfPersonFont=" + kotNoOfPersonFont + ", posmanualPrint=" + posmanualPrint + ", mobBillPrint="
        + mobBillPrint + ", billPrint=" + billPrint + ", vatRegNo=" + vatRegNo + ", serviceTaxNo=" + serviceTaxNo
        + ", poPrintServer=" + poPrintServer + ", parcelServiceTax=" + parcelServiceTax + ", parcelVat=" + parcelVat
        + ", roundOffTotalAmtStatus=" + roundOffTotalAmtStatus + ", kitchenPrintBt=" + kitchenPrintBt + ", billPrintBt="
        + billPrintBt + ", kotCount=" + kotCount + ", discountPercentage=" + discountPercentage + ", vatTaxText="
        + vatTaxText + ", serviceTaxText=" + serviceTaxText + ", vatAmt=" + vatAmt + ", serviceTaxAmt=" + serviceTaxAmt
        + ", parcelAddress=" + parcelAddress + ", multiOrderTable=" + multiOrderTable + ", creditSale=" + creditSale
        + ", customerDisplay=" + customerDisplay + ", parcelText=" + parcelText + ", kotPrintType=" + kotPrintType
        + ", doubleRoundOff=" + doubleRoundOff + ", tableScreen=" + tableScreen + ", softKey=" + softKey
        + ", menuCollapsable=" + menuCollapsable + ", billSplit=" + billSplit + ", isPax=" + isPax + ", printPaidBill="
        + printPaidBill + ", cashDrawerCode=" + cashDrawerCode + ", specialNoteType=" + specialNoteType
        + ", tableLayout=" + tableLayout + ", validateRawStockOut=" + validateRawStockOut + ", validateFgSaleOut="
        + validateFgSaleOut + ", logoXCoordinate=" + logoXCoordinate + ", dbPath=" + dbPath + ", printBillPaperSize="
        + printBillPaperSize + ", serviceChargeText=" + serviceChargeText + ", serviceChargeRate=" + serviceChargeRate
        + ", parcelServiceCharge=" + parcelServiceCharge + ", displayCurrentStockMenu=" + displayCurrentStockMenu
        + ", enterpriseTblLayout=" + enterpriseTblLayout + ", isBarcode=" + isBarcode + ", dayBookReg=" + dayBookReg
        + ", gstText=" + gstText + ", gstRegNo=" + gstRegNo + ", serviceChargeFlag=" + serviceChargeFlag
        + ", waiterNameFlag=" + waiterNameFlag + ", deliveryBoyFlag=" + deliveryBoyFlag + ", countryId=" + countryId
        + ", isProvideReason=" + isProvideReason + ", smsIntegration=" + smsIntegration + ", billCount=" + billCount
        + ", simpleIm=" + simpleIm + ", roomBooking=" + roomBooking + ", ordSucc=" + ordSucc + ", smartIm=" + smartIm
        + ", isRefund=" + isRefund + ", is_account=" + is_account + ", advOrder=" + advOrder + ", negativeStockBilling="
        + negativeStockBilling + ", thanksLine1=" + thanksLine1 + ", thanksLine2=" + thanksLine2 + ", isHr=" + isHr
        + "]";
  }
