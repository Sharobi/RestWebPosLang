...
public class Bill implements Serializable{
	...
	private Double serviceChargeRate; // new added for service charge rate changing dated 12.6.2018
  ...
  public String toString() {
    return "Bill [id=" + id + ", billAmount=" + billAmount + ", grossAmt=" + grossAmt + ", storeId=" + storeId
        + ", totalDiscount=" + totalDiscount + ", customerDiscount=" + customerDiscount + ", roundOffAmt=" + roundOffAmt
        + ", discountPercentage=" + discountPercentage + ", serviceChargeAmt=" + serviceChargeAmt
        + ", serviceChargeRate=" + serviceChargeRate + ", serviceTaxAmt=" + serviceTaxAmt + ", vatAmt=" + vatAmt
        + ", subTotalAmt=" + subTotalAmt + ", discountReason=" + discountReason + ", isNonchargeable=" + isNonchargeable
        + "]";
  }
