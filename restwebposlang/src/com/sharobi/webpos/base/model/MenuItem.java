...
public class MenuItem implements Serializable {
	...
	private int oldStock; // newly added
	private int edpQuantity; // newly added
	private int requiredQuantity; // newly added
	...
	private String isKotPrint; // newly added 21st Feb 2018
	private double promotionDiscountAmt; // newly added 22nd March 2018
	...
	public String toString() {
		return "MenuItem [id=" + id + ", name=" + name + ", description=" + description + ", price=" + price
				...
				+ categoryId + ", categoryName=" + categoryName + ", oldStock=" + oldStock + ", edpQuantity="
				+ edpQuantity + ", requiredQuantity=" + requiredQuantity + ", quantityOfItem=" + quantityOfItem
				+ ", spotDiscount=" + spotDiscount + ", bgColor=" + bgColor + ", currentStock=" + currentStock
				+ ", totalPriceByItem=" + totalPriceByItem + ", isKotPrint=" + isKotPrint + "]";
	}*/
  ...
  public String toString() {
    return "MenuItem [id=" + id + ", name=" + name + ", description=" + description + ", price=" + price
        + ", menucategory=" + menucategory + ", itemtime=" + itemtime + ", deleteFlag=" + deleteFlag + ", storeId="
        + storeId + ", veg=" + veg + ", promotionDesc=" + promotionDesc + ", promotionValue=" + promotionValue
        + ", promotionFlag=" + promotionFlag + ", foodOption1=" + foodOption1 + ", foodOption2=" + foodOption2
        + ", foodOptionFlag=" + foodOptionFlag + ", beverages=" + beverages + ", desert=" + desert + ", spicy=" + spicy
        + ", houseSpecial=" + houseSpecial + ", vat=" + vat + ", serviceTax=" + serviceTax + ", code=" + code
        + ", dailyMinQty=" + dailyMinQty + ", unit=" + unit + ", packaged=" + packaged + ", production=" + production
        + ", cookingTimeInMins=" + cookingTimeInMins + ", subCategoryId=" + subCategoryId + ", subCategoryName="
        + subCategoryName + ", categoryId=" + categoryId + ", categoryName=" + categoryName + ", oldStock=" + oldStock
        + ", edpQuantity=" + edpQuantity + ", requiredQuantity=" + requiredQuantity + ", quantityOfItem="
        + quantityOfItem + ", spotDiscount=" + spotDiscount + ", bgColor=" + bgColor + ", currentStock=" + currentStock
        + ", totalPriceByItem=" + totalPriceByItem + ", isKotPrint=" + isKotPrint + ", promotionDiscountAmt="
        + promotionDiscountAmt + ", purchasePrice=" + purchasePrice + "]";
  } 
