...
public class ReportController {
	...
	@Autowired
	MenuMgntService menumgntService;
	@Autowired
	InventoryService inventoryService;
	@Autowired RoomTypeService rmtypeService;
	...
	public ModelAndView viewUserwiseDailySales(HttpSession session) {
	...
	@RequestMapping(value = "/viewdaywisestockin", method = RequestMethod.GET)
	public ModelAndView loadDaywiseStockIn(HttpSession session) {
		logger.debug("In viewdaywisestockin......");
		ModelAndView mav = new ModelAndView();
		Customer customer = null;
		if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
			mav.setViewName(ForwardConstants.REDIRECT_LOGIN_PAGE);
		...
		mav.addObject(Constants.REPORTS, "Y");
		mav.setViewName(ForwardConstants.VIEW_RPT_DAY_WISE_STOCKIN);
		return mav;
	}
	...
	public ModelAndView loadOutstandingCustomer(HttpSession session) {
		logger.debug("In viewoutstandingcustomer......");
		ModelAndView mav = new ModelAndView();
		Customer customer = null;
		if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
			mav.setViewName(ForwardConstants.REDIRECT_LOGIN_PAGE);
		...
		mav.addObject(Constants.REPORTS, "Y");
		mav.setViewName(ForwardConstants.VIEW_RPT_OUTSTANDING_CUSTOMER);
		return mav;
	}

	@RequestMapping(value = "/viewnewandrepeatcustomer", method = RequestMethod.GET)
	public ModelAndView loadNewAndRepeatCustomer(HttpSession session) {
		logger.debug("In viewnewandrepeatcustomer......");
		ModelAndView mav = new ModelAndView();
		Customer customer = null;
		if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
			mav.setViewName(ForwardConstants.REDIRECT_LOGIN_PAGE);
		...
		mav.addObject(Constants.REPORTS, "Y");
		mav.setViewName(ForwardConstants.VIEW_RPT_NEW_AND_REPEAT_CUSTOMER);
		return mav;
	}

	@RequestMapping(value = "/viewtablewisewaiter", method = RequestMethod.GET)
	public ModelAndView loadviewTableWiseWaiter(HttpSession session) {
		logger.debug("In viewtablewisewaiter......");
		ModelAndView mav = new ModelAndView();
		Customer customer = null;
		if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
			mav.setViewName(ForwardConstants.REDIRECT_LOGIN_PAGE);
		...
		mav.addObject(Constants.REPORTS, "Y");
		mav.setViewName(ForwardConstants.VIEW_RPT_TABLE_AND_WAITER_REPORT);
		return mav;
	}
	...
	public ModelAndView loadRefund(HttpSession session) {
		...
		mav.setViewName(ForwardConstants.VIEW_RPT_PERIODIC_VENDOR_PAYMENT);
		return mav;
	}

	@RequestMapping(value = "/roomreservereport", method = RequestMethod.GET)
	public ModelAndView loadRoomReserveReport(HttpSession session) {
		logger.debug("In viewRoomReserveReport......");
		ModelAndView mav = new ModelAndView();
		Customer customer = null;
		if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
			mav.setViewName(ForwardConstants.REDIRECT_LOGIN_PAGE);
    ...
    mav.addObject("roombookingtypeList",roombookingtypeList); 
		mav.setViewName(ForwardConstants.VIEW_RPT_ROOM_RESERVE_REPORT);
		return mav;
	}

	@RequestMapping(value = "/roombookingreport", method = RequestMethod.GET)
	public ModelAndView loadRoomBookingReport(HttpSession session) {
		logger.debug("In viewRoomBookingReport......");
		ModelAndView mav = new ModelAndView();
		Customer customer = null;
		if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
			mav.setViewName(ForwardConstants.REDIRECT_LOGIN_PAGE);
	  ...
	  List<RoomBookingType> roombookingtypeList=rmtypeService.getRoomBookingTypeByStoreId(customer.getStoreId());
    mav.addObject("roombookingtypeList",roombookingtypeList); 
		mav.setViewName(ForwardConstants.VIEW_RPT_ROOM_BOOKING_REPORT);
		return mav;
	}

	@RequestMapping(value = "/roompaymentwisesalereport", method = RequestMethod.GET)
	public ModelAndView loadRoomPaymentWiseSaleReport(HttpSession session) {
		logger.debug("In roompaymentwisesalereport......");
		ModelAndView mav = new ModelAndView();
		Customer customer = null;
		if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
			mav.setViewName(ForwardConstants.REDIRECT_LOGIN_PAGE);
		...
		mav.addObject(Constants.REPORTS, "Y");
		mav.setViewName(ForwardConstants.VIEW_RPT_ROOM_BOOKING_PAYMENTWISESALE_REPORT);
		return mav;
	}

	
	@RequestMapping(value = "/guestreport", method = RequestMethod.GET)
  public ModelAndView guestReport(HttpSession session) {
    logger.debug("In guestReport......");
    ModelAndView mav = new ModelAndView();
    Customer customer = null;
    if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
      mav.setViewName(ForwardConstants.REDIRECT_LOGIN_PAGE);
    ...
    mav.addObject(Constants.REPORTS, "Y");
    mav.setViewName(ForwardConstants.VIEW_RPT_GUEST_LIST_REPORT);
    return mav;
  }
	
	@RequestMapping(value = "/flashreport", method = RequestMethod.GET)
  public ModelAndView flashReport(HttpSession session) {
    logger.debug("In guestReport......");
    ModelAndView mav = new ModelAndView();
    Customer customer = null;
    if ((customer = (Customer) session.getAttribute(Constants.LOGGED_IN_USER)) == null) {
    ...
    mav.addObject(Constants.REPORTS, "Y");
    mav.setViewName(ForwardConstants.VIEW_RPT_FLASH_REPORT);
    return mav;
  }
