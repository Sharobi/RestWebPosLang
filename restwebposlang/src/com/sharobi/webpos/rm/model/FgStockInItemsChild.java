...
public class FgStockInItemsChild implements Serializable {
  ...
  public String toString() {
    return "FgStockInItemsChild [id=" + id + ", storeId=" + storeId + ", menuItem=" + menuItem + ", fgStockInId="
        ...
        + stockInQuantity + ", oldStockInQuantity=" + oldStockInQuantity + ", deleteFlag=" + deleteFlag + ", createdBy="
        + createdBy + ", createdDate=" + createdDate + ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate
        + ", unit=" + unit + ", itemRate=" + itemRate + ", itemTotal=" + itemTotal + ", discPer=" + discPer
        + ", discAmt=" + discAmt + ", vatRate=" + vatRate + ", vatAmt=" + vatAmt + ", serviceTaxRate=" + serviceTaxRate
        + ", serviceTaxAmt=" + serviceTaxAmt + ", totalPrice=" + totalPrice + ", curStock=" + curStock + ", prevretQty="
        + prevretQty + ", stockId=" + stockId + ", stockDate=" + stockDate + ", vndrId=" + vndrId + ", vndrName="
        + vndrName + ", invNo=" + invNo + "]";
  }
