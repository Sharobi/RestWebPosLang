...
public class EstimateDailyProd implements Serializable {
	...
	private String requisitionPoDate;
	...
	public String getRequisitionPoDate() {
		return requisitionPoDate;
	}

	public void setRequisitionPoDate(String requisitionPoDate) {
	...
	public String toString() {
		return "EstimateDailyProd [id=" + id + ", estimateType=" + estimateType + ", storeId=" + storeId + ", date=" + date + ", total=" + total + ", approved=" + approved + ", approvedBy=" + approvedBy + ", requisitionPoStatus=" + requisitionPoStatus + ", requisitionPoStatusBy=" + requisitionPoStatusBy + ", fgStockInStatus=" + fgStockInStatus + ", fgStockInStatusBy=" + fgStockInStatusBy + ", deleteFlag=" + deleteFlag + ", createdBy=" + createdBy + ", createdDate=" + createdDate + ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate + ", estimateDailyProdItems=" + estimateDailyProdItems + ", dateText=" + dateText + ", requisitionPoDate=" + requisitionPoDate + ", fgStockInDate=" + fgStockInDate + ", poId=" + poId + ", fgStockInId=" + fgStockInId + ", rawStockOutId=" + rawStockOutId + ", estimatedQuantity=" + estimatedQuantity + ", totalEstimatedQty=" + totalEstimatedQty + ", totalStockInQty=" + totalStockInQty + ", rawStockOutStatus=" + rawStockOutStatus
				+ ", rawStockOutStatusBy=" + rawStockOutStatusBy + ", rawStockOutDate=" + rawStockOutDate + "]";
	}
}
