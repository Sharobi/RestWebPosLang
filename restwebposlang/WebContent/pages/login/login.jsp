...
<body style="background: #fff;">
	...
	<header>
		<div class="container-fluid">
			<%-- <div class="row">
				<a style="float: left" href="${pageContext.request.contextPath }/authentication/login.htm"> <img src="${pageContext.request.contextPath }/assets/images/header/yp_pos_topbarlogo.png" />
				</a>
			</div> --%>
			
			<!--Use this div for all users except Australians    -->
			<div class="row">
				<a style="float: left"
					href="${pageContext.request.contextPath }/authentication/login.htm">
					<img
					src="${pageContext.request.contextPath }/assets/images/header/yp_pos_topbarlogo.png" />
				</a>
			</div>
			<!--Use this div for only Australian user   -->
			<div class="row" style="display: none;">
				<a style="float: left"
					href="${pageContext.request.contextPath }/authentication/login.htm">
					<img
					src="${pageContext.request.contextPath }/assets/images/header/weblogo.png" />
				</a>
			</div>
		</div>
	</header>
	<!-- HEADER END-->
	<div class="navbar navbar-inverse set-radius-zero" style="background: #065592;">
		<div class="container-fluid">
			...
			<div class="row">
			<div class="col-md-9" style="padding-top: 10px; text-align: right;text-transform: uppercase; color: #fff;" >
			
			<%-- <strong><spring:message code="login.jsp.language" text="LANGUAGE" /> : </strong>
			    <a style="color: #fff;" href="${pageContext.request.contextPath }/authentication/login.htm?lang=en">
			    <spring:message code="login.jsp.english" text="ENGLISH" /></a> 
			    | 
			    <a style="color: #fff;" href="${pageContext.request.contextPath }/authentication/login.htm?lang=ar">
			    <spring:message code="login.jsp.arabic" text="ARABIC" /></a> --%>
			</div>
			</div>
		</div>
	</div>
	<div class="content-wrapper">
		...
		<div class="container-fluid" id="containerId" style="background-image:url('${pageContext.request.contextPath }/assets/images/login/yewpos-splash.jpg');margin-top:-12px;
      background-size:cover; padding-top:66px; background-position:center; ">
			...
			<div class="col-md-4 col-sm-4">
				...
				<div style="background-image:url('${pageContext.request.contextPath }/assets/images/login/loginpanel_tp.png');margin: 50px auto; padding: 10px 30px; text-align:center;width:80%">
					<h1 style="color: #fff"><spring:message code="login.jsp.login" text="LOGIN" /></h1>
					<form:form modelAttribute="user" action="${pageContext.request.contextPath }/authentication/dologin.htm" method="post" role="form">
						...
						<input type="submit" value="<spring:message code="login.jsp.login" text="LOGIN" />" class="btn btn-info">
		...
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				...
				<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
					...
					<div style="text-align: center; font-size: 20px;">
						Enter Product Key :<br /> <font color="black"><input type="text" size="25" id="productkey" value="QWFhYUREemRtMDFQd2Fk" /></font>
					</div>
				</div>
				<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
