...
<body id="prdiv">
	<div class="container bordereddiv"  >
		...
		<div class="row text-center bordertopdiv">
			<table style="margin-bottom: 0px; width: 100%; ">
				<tr>
					<td class="text-left"  style=" width:  35%;padding-left: 2%;"><b>Vou. No. :</b>${custDet.invNo}</td>
					<td><b>  <span id="payMode"></span> Payment</b></td>
					<td class="text-right"  style=" width:  35%;">Date : <fmt:parseDate value="${custDet.invDate}" var="paymentInvDate" pattern="MMM dd, yyyy" /> <fmt:formatDate pattern="yyyy-MM-dd" value="${paymentInvDate}" />
			...
			<div class="col-sm-12" style="padding-left: 2%;">
				...
				<p   >Paid on account of  <b>  &nbsp;${custDet.supplierName}</b> <span id="chequDetails"></span></p>
		...
		<div class="row ">
				 ...
				 <tr>
				  ...
				  <tr>
				    <td width="80%;" style=" padding-left: 2%; border-right:1px solid #000;"> ${custDet.remarks}  <br> <br><br></td> <td width="20%;"  style=" text-align: right;padding-right: 2%;"> ${cur} :  <fmt:formatNumber type = "number"   maxFractionDigits = "2" value = "${ custDet.payAmount}" /><br> <br><br></td>
				 </tr>
				  <tr>
				    <td width="80%;"  style=" padding-left: 2%; border-right:1px solid #000;"><b>${cur}  (in words) :</b>  <span id="priceword"></span> only</td> <td width="20%;"  style="text-align: right;  padding-right: 2%;" >${cur} : <fmt:formatNumber type = "number"   maxFractionDigits = "2" value = "${ custDet.payAmount}" /></td>
				 </tr>
				 </table>
	...
	<%--
		<div class="row bordertopdiv">
			<div class="col-sm-12">
				<br/>
				<p>Received with thanks from <b>${custDet.supplierName}</b> <span id="chequDetails"></span></p>
