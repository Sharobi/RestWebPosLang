...
<body onload="getSelectVal()">
	...
	<c:if test="${sessionScope.loggedinStore.dayBookReg=='Y'}">
		<c:if test="${restopendet.id==0}">
			...
			<div class="modal fade" data-backdrop="static" id="restOpenModal"
	...
	<div class="content-wrapper" style="overflow: hidden;">
		...
		<div class="container-fluid" id="containerId"
			style="margin-top: -12px; background-position: center; background-size: cover;">
			<div class="row" style="margin-top: 12px;">
				...
				<div class="col-lg-4 col-md-4">
					<div class="row" style="text-align: center;">
						...
						<div class="col-lg-4 col-xs-12" style="padding-right: 20px;">
							<c:if test="${langlist.size() > 1}">
								<div id="select_language">
									<select id="dropdown_value"
										style="float: right; background-color: #202020; color: #FFF">
										<c:choose>
											<c:when test="${not empty sessionScope.selectedLang}">
												<option id="selct_VAL" disabled="disabled"
													selected='selected'>${sessionScope.selectedLang}</option>
			...
			<div class="row" style="margin-top: 10px; padding-left: 42px;">
			 <div class="col-lg-2 col-xs-4 test"
			...
			<div class="row" style="margin-top: 10px;padding-left: 10px;">
				<div class="col-lg-4 col-md-4">
					<div class="panel panel-primary"
						style="width: 90%; margin-bottom: 1%;margin-left: 10%; ">
				...
				<div class="col-lg-4 col-md-4">
					<div class="panel panel-primary"
						style="width: 90%; margin-bottom: 1%;margin-left: -1%;">
						<canvas id="doughnut" style="background-color: #31708f00;"
							height="270vw" width="558vw"></canvas>
					</div>
				</div>
			</div>
			<div class="row" style="margin-top: 5px; padding-left: 35px;">
	...
	<script type="text/javascript">
         ...
         $('select').on(
         		...
         		function() {
         			...
         			location.href = BASE_URL + "/home/welcome.htm?lang="
         					+ getSelectedLanguage;
         		});
         $(document).ready(function() {
        	 ...
        	 if(startDate>endDate){
        		 document.getElementById("alertmsg").innerHTML="Please Enter Correct Date Range";
        		  ...
        		  var ajaxCallObject = new CustomBrowserXMLObject();
        	    	 ajaxCallObject.callAjaxPost(BASE_URL + "/home/getBoxData.htm", commonResultSetMapper, function(response) {
        ...
        function getAllDataPie1()
        	 ...
        	 if(startDate>endDate){
        		 document.getElementById("alertmsg").innerHTML="Please Enter Correct Date Range";
        		  ...
        		  var ajaxCallObject = new CustomBrowserXMLObject();
        	    	 ajaxCallObject.callAjaxPost(BASE_URL + "/home/getPaymentSummary.htm", commonResultSetMapper, function(response) {
                         var res = JSON.parse(response);
    	 ...
    	 var startDate = document.getElementById("startdate").value; 
     	 ...
     	 if(startDate>endDate){
     		 document.getElementById("alertmsg").innerHTML="Please Enter Correct Date Range";
     		  ...
     		  var ajaxCallObject = new CustomBrowserXMLObject();
     	    	 ajaxCallObject.callAjaxPost(BASE_URL + "/home/getDashSaleSummaryOrderType.htm", commonResultSetMapper, function(response) {
                    var res = JSON.parse(response);
    	 ...
    	 var startDate = document.getElementById("startdate").value; 
      	 ...
      	 if(startDate>endDate){
      		 document.getElementById("alertmsg").innerHTML="Please Enter Correct Date Range";
      		  ...
      		  var ajaxCallObject = new CustomBrowserXMLObject();
      	    	 ajaxCallObject.callAjaxPost(BASE_URL + "/home/getDashSaleSummaryPaymentType.htm", commonResultSetMapper, function(response) {
                     var res = JSON.parse(response);
          ...
          */
     	 ...
     	 if(startDate>endDate){
     		 document.getElementById("alertmsg").innerHTML="Please Enter Correct Date Range";
     		  ...
     		  var ajaxCallObject = new CustomBrowserXMLObject();
     	    	 ajaxCallObject.callAjaxPost(BASE_URL + "/home/getDashTopCustomer.htm", commonResultSetMapper, function(response) {
                    var res = JSON.parse(response);
          ...
          */
     	 ...
     	 if(startDate>endDate){
     		 document.getElementById("alertmsg").innerHTML="Please Enter Correct Date Range";
     		  ...
     		  var ajaxCallObject = new CustomBrowserXMLObject();
     	    	 ajaxCallObject.callAjaxPost(BASE_URL + "/home/getDashTopItem.htm", commonResultSetMapper, function(response) {
                    var res = JSON.parse(response);
