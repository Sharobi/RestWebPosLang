...
<body>
			...
			<div class="row">
				<div class="col-md-10 col-sm-10">
					<div style="height: 100%; width: 100%;">
            			...
            			<spring:message code="admin.table.jsp.noTabFound" text="No Table found!!!!" />
            			</c:if>
							<c:if test="${!empty tableList }">
									...
									<c:if test="${sessionScope.loggedinStore.tableLayout=='Y'}">
										<c:choose>
											<c:when test="${sessionScope.loggedinStore.multiOrderTable=='N'}">
												<div class="table-holder" style="position: absolute; top:${tables.yPos}px; left:${tables.xPos}px;">
														...
														<div class="postable booked" onclick="javascript:clickOnTable('${tables.tableId}','${tables.tableNo}','${tables.order.id}','0')">
															...
															<div class="table-info">
																<c:if test="${sessionScope.loggedinStore.id!=37 && sessionScope.loggedinStore.id!=38}">
																	...
																	<div class="table-subinfo">${tables.seatingCapacity}<spring:message code="admin.table.jsp.seaters" text="SEATERS" /></div>
																</c:if>
																<div class="table-subinfo">${tables.noofItem}<spring:message code="admin.table.jsp.items" text="ITEMS" /></div>
													...
													<c:if test="${tables.status=='Y' && tables.isBooked=='Y' && tables.ischildTable=='Y'}">
														<div class="postable booked">
															...
															<div class="table-info">
																...
																<div class="table-subinfo"><spring:message code="admin.table.jsp.mergewith" text="Merged with" /></div>
																<div class="table-subinfo"><spring:message code="admin.table.jsp.tableno" text="Table No:" />${tables.parentTable}</div>
															</div>
															<br style="clear: both;">
														</div>
													</c:if>
															...
															<c:if test="${tables.status=='Y' && tables.isBooked=='Y' && tables.ischildTable=='N'}">
																<div class="postable booked" onclick="javascript:showmultitableOrderModal('${tables.tableId}','${tables.tableNo}','${tables.noofOrder}',${tables.seatingCapacity})">
																	...
																	<div class="table-info">
																		...
																		<div class="table-subinfo"><spring:message code="admin.table.jsp.multiorder" text="Multiorder" /></div>
																		<div class="table-subinfo">${tables.noofOrder}<spring:message code="admin.table.jsp.orders" text="ORDERS" /></div>
																	</div>
																	<br style="clear: both;">
																</div>
															</c:if>
						...
						<div style="padding: 8px; height: 500px;">
							<div class="item" style="margin-bottom: 10px;">
								<select id="TableId" style="padding: 5px 0 5px 0; width: 100%; color: #222222;">
									<option value="0"><spring:message code="admin.table.jsp.slctTab" text="Select Table"/></option>
							...
							<div class="item item-sub-child" style="background: #72bb4f;">
								<a href="javascript:updatetableStatus(1)"><spring:message code="admin.table.jsp.enabled" text="ENABLED" /></a>
							</div>
							<div class="item item-sub-child" style="background-color: #e32b2b;">
								<a href="javascript:updatetableStatus(2)"><spring:message code="admin.table.jsp.disabled" text="DISABLED" /></a>
							</div>
							...
							<%-- <c:if test="${sessionScope.loggedinStore.parcelFlag=='Y'}">
								<div class="item item-sub-child" style="background-color: #ff7a41; margin-top: 50px;">
									<a href="${pageContext.request.contextPath}/order/vieworder.htm?ono=0&tno=0&sno=0"><spring:message code="admin.table.jsp.parcel" text="PARCEL" /></a>
								</div>
							</c:if>
							<c:if test="${sessionScope.loggedinStore.homeDeliveryFlag=='Y'}">
								<div class="item item-sub-child" style="background-color: #da84cb;">
									<a href="${pageContext.request.contextPath}/order/vieworderHD.htm?ono=0&tno=0&sno=0&ot=h"><spring:message code="admin.table.jsp.homedelivery" text="HOME DELIVERY" /></a>
								</div>
							</c:if>
 ...
 --%>
							<div id="order_type" class="col-md-12 col-sm-12"
								style="font-size: 20px; font-weight: bold; text-transform: uppercase; margin-top: 50px; width: 100%; height: 100%;">
								<spring:message code="admin.tablenew.jsp.OrderType"
									text="Order Type" />
								<select id="orderType" style="color: black;"
									onchange="javascript:selectOrderType()">
									<option value="SELECT"
										style="text-align: center; font-size: 14px; font-weight: bold;"><spring:message
											code="admin.tablenew.jsp.Select" text="SELECT" /></option>
									<c:forEach items="${orderTypeList}" var="typeList">
										<c:if test="${typeList.orderTypeName!='Dine In' }">
											<option value="${typeList.id}"
												style="text-align: center; font-size: 14px; font-weight: bold;">${typeList.orderTypeName}</option>
										</c:if>>
                			</c:forEach>
								</select>
							</div>
				...
				<div class="modal-dialog" style="margin: 100px auto;">
					<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
						<div class="modal-header" style="background: #939393; color: #fff; border-bottom: 1px solid #939393;">
							...
							<h4 class="modal-title" style="font-size: 18px; font-weight: bold;" id="myModalLabel"><spring:message code="admin.table.jsp.alert" text="Alert!" /></h4>
						</div>
						<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
							<div style="text-align: center; font-size: 20px;"><spring:message code="admin.table.jsp.plSlctTable" text="Please select a table!" /></div>
						</div>
						<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
							<button type="button" style="background: #72BB4F; font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.table.jsp.ok" text="OK" /></button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal fade" data-backdrop="static" id="bookedtablealertModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
				<div class="modal-dialog" style="margin: 100px auto;">
					<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
						...
						<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
							<div style="text-align: center; font-size: 20px;"><spring:message code="admin.table.jsp.tabBooked" text="This table is booked,cannot be disabled!" /></div>
						</div>
						<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
							<button type="button" style="background: #72BB4F; font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.table.jsp.ok" text="OK" /></button>
						</div>
				...
				<div class="modal-dialog" style="margin: 100px auto;">
					<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
						<div class="modal-header" style="background: #939393; color: #fff; border-bottom: 1px solid #939393;">
							...
							<h4 class="modal-title" style="font-size: 18px; font-weight: bold;" id="myModalLabel"><spring:message code="admin.table.jsp.confrmtion" text="Confirmation!" /></h4>
						</div>
						<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
							<div style="text-align: center; font-size: 20px;">
								<spring:message code="admin.table.jsp.areYouSure" text="Are you sure?" /> <input type="hidden" value="" id="targettableId"> <input type="hidden" value="" id="targettableOpt">
							</div>
						</div>
						<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
							<button type="button" style="background: #F60; font-weight: bold; width: 25%;" class="btn btn-warning" data-dismiss="modal"><spring:message code="admin.table.jsp.cancel" text="CANCEL" /></button>
							<button type="button" onclick="javacsript:updateTableOperation()" style="background: #72BB4F; font-weight: bold; width: 25%;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.table.jsp.ok" text="OK" /></button>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
						<div class="modal-header" style="background: #939393; color: #fff; border-bottom: 1px solid #939393;">
							...
							<h4 class="modal-title" style="font-size: 18px; font-weight: bold;" id="myModalLabel">
								<spring:message code="admin.table.jsp.tableno" text="Table No:" /> <span id="multitableOrderModaltabcontId">00</span> <span style="float: right;"><spring:message code="admin.table.jsp.noOfOrder" text="NO OF ORDER:"/> <span id="multitableOrderModalnoofordercontId">0</span></span>
						...
						<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
							<button type="button" style="width: 30%; background: #F60; font-weight: bold;" class="btn btn-warning" data-dismiss="modal"><spring:message code="admin.table.jsp.cancel" text="CANCEL"/></button>
	...
	function createNewMultiOrder(tableid,tableno,capacity)
	{
	 ...
	 <c:choose>
    <c:when test="${pageContext.response.locale == 'arabic'}">
