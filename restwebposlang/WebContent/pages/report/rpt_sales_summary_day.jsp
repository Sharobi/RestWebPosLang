        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				<div class="col-md-12 col-sm-12" align="center">
                    <span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_sales_summary_day.jsp.cont_one" text="Select Date For Daily Sales Summary" /></span>&nbsp;&nbsp;
                   ...
                   <a href="javascript:showpdfrptdaywisesummarySales(document.getElementById('daterptdaywisesummarySales').value,${sessionScope.loggedinUser.storeId})" class="btn btn-success" style="background:#41A1E3;margin-bottom: 3px;"><spring:message code="admin.rpt_sales_summary_day.jsp.submit" text="SUBMIT" /></a> 
                </div>
                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        <div class="modal-header" style="background: #939393;color: #fff;border-bottom: 1px solid #939393;">
                                            ...
                                            <h4 class="modal-title" style="font-size: 18px;font-weight: bold;" id="myModalLabel"><spring:message code="admin.rpt_sales_summary_day.jsp.alert" text="Alert!" /></h4>
                                        </div>
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div style="text-align: center;font-size: 20px;">
                                            <spring:message code="admin.rpt_sales_summary_day.jsp.cont_two" text="Given date is greater than today's date!" />
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button"  style="background: #72BB4F;font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.rpt_sales_summary_day.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
