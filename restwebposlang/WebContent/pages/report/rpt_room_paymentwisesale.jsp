...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS :: Room Payment Wise Sale :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message
													code="rb.rpt.room.paymentwisesale"
													text="Payment Wise Sale" /></span>
				</div>
   ...
   var pdf_url_roombooking_paymentwisesale_details='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_ROOMBOOKING_PAYMENTWISESALE_REPORT)%>';
