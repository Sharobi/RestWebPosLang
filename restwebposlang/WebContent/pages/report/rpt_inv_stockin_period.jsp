    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_inv_stockin_period.jsp.cont_one" text="Period Wise Stock In Report" /></span>
				</div>
				<div class="col-md-9 col-sm-9">
                    <span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_inv_stockin_period.jsp.frmDate" text="From Date:" /></span>
                    <input type="text" id="fromdaterptperiodwiseStockIn" size="7" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                    <span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_inv_stockin_period.jsp.toDate" text="To Date:" /></span>
                    <input type="text" id="todaterptperiodwiseStockIn" size="7" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                     ...
                     <span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_inv_stockin_period.jsp.period" text="Period:" /></span>
                    <select id="periodtyperptStockIn">
                    	<option value="daily"><spring:message code="admin.rpt_inv_stockin_period.jsp.daily" text="Daily" /></option>
                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        <div class="modal-header" style="background: #939393;color: #fff;border-bottom: 1px solid #939393;">
                                            ...
                                            <h4 class="modal-title" style="font-size: 18px;font-weight: bold;" id="myModalLabel"><spring:message code="admin.rpt_inv_stockin_period.jsp.alert" text="Alert!" /></h4>
                                        </div>
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div style="text-align: center;font-size: 20px;">
                                            <spring:message code="admin.rpt_inv_stockin_period.jsp.cont_two" text="Given date is greater than today's date!" />
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button"  style="background: #72BB4F;font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.rpt_inv_stockin_period.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" data-backdrop="static" id="alertrptstockinperiodgreaterModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div style="text-align: center;font-size: 20px;">
                                            <spring:message code="admin.rpt_inv_stockin_period.jsp.cont_three" text="From Date is greater than To Date!" />
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button"  style="background: #72BB4F;font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.rpt_inv_stockin_period.jsp.changePW" text="CHANGE" /><spring:message code="admin.rpt_inv_stockin_period.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
