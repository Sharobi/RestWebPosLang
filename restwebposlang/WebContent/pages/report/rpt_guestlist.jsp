...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS :: Guest List Report :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message
													code="rb.rpt.room.booking.guest_list"
													text="Guest List" /></span>
				</div>
				<div class="col-md-9 col-sm-9">
                   ...
                   <a href="javascript:showpdfguestlistreport(document.getElementById('fromdate').value,document.getElementById('todate').value,${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value)" class="btn btn-success" style="background:#0CF;margin-bottom: 3px;"><spring:message code="admin.rpt_inv_po_period.jsp.submit" text="SUBMIT" /></a>
                </div> 
                </div>
                <div class="col-md-12 col-sm-12">
                  <div id="guestListContainerId" > 
                  </div> 
               </div>
           </div>
       </div>
   ...
   var pdf_url_rpt_guestlist='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_GUEST_LIST)%>';
