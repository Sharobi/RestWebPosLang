...
<c:set var="today" value="<%=new java.util.Date()%>" />
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message
													code="rb.rpt.room.booking.flashreport"
													text="Flash Report" /></span>
				</div>
				<div class="col-md-9 col-sm-9">
                    <span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_inv_po_period.jsp.Date" text="Date:" /></span>
                    <input type="text" id="fromdate" size="10" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                   <%--  <span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_inv_po_period.jsp.toDate" text="To Date:" /></span>
                    <input type="text" id="todate" size="10" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />"> --%>
                     <input type="hidden" id="hiddendate" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                   ...
                   <a href="javascript:showflashreport(document.getElementById('fromdate').value,${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value)" class="btn btn-success" style="background:#0CF;margin-bottom: 3px;"><spring:message code="admin.rpt_inv_po_period.jsp.submit" text="SUBMIT" /></a>
                </div> 
                </div>
                <div class="col-md-12 col-sm-12">
                  <div id="flashReportContainerId" > 
                  </div> 
               </div>
           </div>
       </div>
   ...
   var pdf_url_rpt_flashreport='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_FLASH_REPORT)%>';
