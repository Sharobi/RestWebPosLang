...
<!--[if IE]>
        ...
        <![endif]-->
<title>:. POS :: Outstanding Customer Report :.</title>
				...
				<div class="col-md-10 col-sm-10">
					<div class="col-md-12 col-sm-12" align="center">
						<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
								code="admin.rpt_customer_list.jsp.outstandingCustomer"	text="Outstanding Customers Details" /></span>&nbsp;&nbsp; 
								...
								<a href="javascript:showpdfrptoutstandingcustomerlist(${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value)"
