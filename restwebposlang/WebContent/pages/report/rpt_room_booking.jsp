...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS :: Room Booking Details :.</title>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				...
				<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="rb.rpt.room.booking" text="Booking Details" /></span>
				</div>
				<div class="col-md-10 col-sm-10">
                    ...
                    <span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="rb.admin.roombooking.bookingtype" text="BOOKING TYPE" /></span>
                    <select  id="roombookingType">
                   ...
                   <a href="javascript:showpdfrptroombookingdetails(document.getElementById('fromdaterptrefunddetails').value,document.getElementById('todaterptrefunddetails').value,${sessionScope.loggedinUser.storeId},document.getElementById('roombookingType').value,document.getElementById('rptType').value)" class="btn btn-success" style="background:#0CF;margin-bottom: 3px;"><spring:message code="admin.rpt_inv_po_period.jsp.submit" text="SUBMIT" /></a>
                </div> 
                </div>
                <div class="col-md-12 col-sm-12">
                  <div id="roombookingdetailsreportContainerId" > 
                  </div> 
               </div>
           </div>
       </div>
   ...
   var pdf_url_roombooking_booking_details='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_REPORT_ROOMBOOKING_BOOKING_DETAILS_REPORT)%>';
