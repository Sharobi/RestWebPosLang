...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS :: Account Balance</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
					...
					<center>
					<table>
						<tr align="center" style="font-weight: bold;color:#FFF; font-size:16px; font-weight:bold;">
					...
					<tr>
						...
						<fmt:parseDate value="${sessionScope.sesloggedinUser.endDate}" var="parsedEndDate" pattern="yyyy-MM-dd" />
								...
								<td style="padding: 0 1px;">
									<select class="form-control-trx" name="accountgroup_id" id="accountgroup_id" style="height: 28px;">
								...
								<td>
									...
									<input class="form-control-trx" type="text" style="height: 28px;" id="account_name"  onkeyup="auto_com();" placeholder="Account Name(Please type atleast 2 characters)">
									
								</td> 
								
								<td>
									<select style="height: 28px;" class="form-control-trx" name="report_format" id="report_format">
...
// });
var pdf_url_purchase_itemwise='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_ACCOUNT_BALANCE)%>';
	...
	function getCurrPurchaseItems(){
				...
				var report_format= $('#report_format').val();
					...
					var  final_url=pdf_url_purchase_itemwise+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&accountgroup_id="+group_id+"&account_id="+account_id+"&asOnDate="+enddate+"&report_format="+report_format+"";
