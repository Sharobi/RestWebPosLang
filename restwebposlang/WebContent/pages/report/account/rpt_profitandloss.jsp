...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS ::Profit And Loss</title>
...
var pdf_url_purchase_itemwise='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_ACCOUNT_PROFIT_AND_LOSS)%>';
