           ...
           <div class="col-md-10 col-sm-10">
					...
					<center>
						...
						<tr align="center" style="font-weight: bold;">
								...
								<td align="center" style="color:#FFF; font-size:16px; font-weight:bold;"> <spring:message code="accgroup.jsp.asondate" text="As on Date" /> 	</td>
								<td style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="accgroup.jsp.report_type" text="Report Type" /> </td>
								<td style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="accgroup.jsp.notinclouding" text="Not Including Zero" /> </td>
						...
						<fmt:parseDate value="${sessionScope.sesloggedinUser.endDate}" var="parsedEndDate" pattern="yyyy-MM-dd" />
						 	...
						 	<td style="padding: 0 1px;" >
									<select class="form-control-trx" name="trial_type" id="trial_type"  style="height: 26px;" >
						  	...
						  	<td style="padding: 0 1px;"  align="center" >
							 				 <input type="checkbox"  style="height: 26px;" id="isExcludingZero" name="isExcludingZero" >
								</td>
