        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
					...
					<%-- 	  <td width="10%" ><spring:message code="accgroup.jsp.report_type" text="Report Type" /></td> --%>
								<td id="col_from_date_head" style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="purinvreg.jsp.frmdt" text="From Date" /></td>
								<td align="center">
								<span id="todata_heading" style="color:#FFF; font-size:16px; font-weight:bold;" align="center"><spring:message code="purinvreg.jsp.todt" text="To Date" /></span>
								<span id="ason_heading" style="color:#FFF; font-size:16px; font-weight:bold;" align="center"><spring:message code="accgroup.jsp.asondate" text="As on Date" /></span>

								</td>

								 <td width="25%" id="ledger_group"  style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="accsetup.jsp.accountgroupname" text="Account Group Name" /></td>
								<td width="23%"  style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="accsetup.jsp.partyaccountname" text="Account Name " /></td>
						...
						<fmt:parseDate value="${sessionScope.sesloggedinUser.endDate}" var="parsedEndDate" pattern="yyyy-MM-dd" />
							...
							<!-- 	<td style="padding: 0 1px;">
								...
								<td style="padding: 0 1px;">
									<select class="form-control-trx" name="accountgroup_id" id="accountgroup_id" style="height: 26px;">
								...
								<td>
									<div class="col-lg-4 col-md-4 col-sm-12">
										<button type="button" style="background:#41A1E3;margin-bottom: 3px;" class="btn btn-theme" onclick="getCurrPurchaseItems()"><spring:message code="cmn.jsp.btn.submit" text="Submit" /></button>
									</div>
								</td>
...
var pdf_url_purchase_itemwise='<%=CommonResource.getProperty(CommonResource.TARGET_WEBSERVICE_ENDPOINT)+CommonResource.getProperty(CommonResource.WEBSERVICE_ACCOUNT_REPORT)%>';
	...
	function getCurrPurchaseItems(){
		...
		var report_format= $('#report_format').val();
			...
			var  final_url=pdf_url_purchase_itemwise+"?cmpnyId="+compid+"&storeId="+storeid+"&finYrId="+finyrid+"&startDate="+strtdate+"&endDate="+enddate+"&accountgroup_id="+group_id+"&account_id="+account_id+"&report_format="+report_format+"";
