            ...
            <div class="col-md-10 col-sm-10">
				<div class="col-md-12 col-sm-12" align="center">
                      <div class="col-md-3 col-sm-3">
	           				<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.rpt_inv_current_stock.jsp.invCurStockRept1" text="Inventory Current Stock Report" /></span>
           			  </div>
                   ...
                   <spring:message code="admin.rpt_inv_current_stock.jsp.get1" text="GET" /> 
                   </a>  
                   </div>
                </div>
                <div class="col-md-12 col-sm-12" align="center">
                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        <div class="modal-header" style="background: #939393;color: #fff;border-bottom: 1px solid #939393;">
                                            ...
                                            <h4 class="modal-title" style="font-size: 18px;font-weight: bold;" id="myModalLabel"><spring:message code="admin.rpt_inv_current_stock.jsp.alert" text="Alert!" /></h4>
                                        </div>
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div style="text-align: center;font-size: 20px;">
                                            <spring:message code="admin.rpt_inv_current_stock.jsp.cont_one" text="Given date is greater than today's date!" />
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button"  style="background: #72BB4F;font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.rpt_inv_current_stock.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
