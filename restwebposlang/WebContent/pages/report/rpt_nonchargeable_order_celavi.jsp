           ...
           <div class="col-md-10 col-sm-10">
				...
				<div class="col-md-9 col-sm-9">
                    ...
                    <input type="text" id="todaterptncOrderscelavi" size="7" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                     ...
                     <a href="javascript:showpdfrptncOrderscelavi(document.getElementById('fromdaterptncOrderscelavi').value,document.getElementById('todaterptncOrderscelavi').value,${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value)" class="btn btn-success" style="background:#41A1E3;margin-bottom: 3px;"><spring:message code="admin.rpt_item_wise_order_period.jsp.submit" text="SUBMIT" /></a> 
