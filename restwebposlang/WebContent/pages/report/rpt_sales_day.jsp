	...
	<div class="content-wrapper">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<div class="col-md-12 col-sm-12" align="center">
						<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
								code="admin.rpt_sales_day.jsp.cont_two"
								text="Select Date For Day wise Sales" /></span>&nbsp;&nbsp;
                      ...
                      --%>
						<c:choose>
							<c:when
								...
								<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
										code="inventorynew.jsp.Date"
										text="Date" /></span>
								<input type="text" id="daterptdaywiseSales" size="7"
									value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
								<input type="text" style="display: none;"
									id="todaterptdaywiseSales" size="7"
									value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
							</c:when>

							<c:otherwise>
								<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
										code="admin.rpt_inv_stockout_allcat_period.jsp.frmDate"
										text="From Date:" /></span>
								<input type="text" id="daterptdaywiseSales" size="7"
									value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
								<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
										code="admin.rpt_inv_stockout_allcat_period.jsp.toDate"
										text="To Date:" /></span>
								<input type="text" id="todaterptdaywiseSales" size="7"
									value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">

							</c:otherwise>
						</c:choose>

						<input type="hidden" id="hiddaterptdaywiseSales"
							value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">

						<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
								code="admit_rpt_rpttype" text="Report Type" /></span>&nbsp;&nbsp; <select
							id="rptType">
							<option value="1">PDF</option>
							<option value="2">Excel</option>
						</select> <a
							href="javascript:showpdfrptdaywiseSales(document.getElementById('daterptdaywiseSales').value,document.getElementById('todaterptdaywiseSales').value,${sessionScope.loggedinUser.storeId},document.getElementById('rptType').value)"
							class="btn btn-success"
							style="background: #FF8576; margin-bottom: 3px;"><spring:message
								code="admin.rpt_sales_day.jsp.submit" text="SUBMIT" /></a>
					</div>
					<div class="col-md-12 col-sm-12">
						<div id="daywisesalereportContainerId"></div>
					</div>
				</div>
				<!-- modal starts -->
				<div class="modal fade" data-backdrop="static"
					id="alertrptsalesdayModal1" tabindex="-1" role="dialog"
						...
						<div class="modal-content"
							...
							<div class="modal-header"
								...
								<h4 class="modal-title"
									...
									<spring:message code="admin.rpt_sales_day.jsp.alert"
										text="Alert!" />
								</h4>
							</div>
							<div class="modal-body"
								...
								<div style="text-align: center; font-size: 20px;">
									<spring:message code="admin.rpt_sales_day.jsp.cont_one"
							...
							<div class="modal-footer"
								...
								<button type="button"
									...
									<spring:message code="admin.rpt_sales_day.jsp.ok" text="OK" />
								</button>
							</div>
						</div>
					</div>
				...
				<div class="modal fade" data-backdrop="static"
					id="alertrptsalesdayModal2" tabindex="-1" role="dialog"
					aria-labelledby="myModalLabel" aria-hidden="true"
					style="display: none;">
					<div class="modal-dialog" style="margin: 100px auto;">
						<div class="modal-content"
							...
							<div class="modal-header"
								...
								<h4 class="modal-title"
									style="font-size: 18px; font-weight: bold;" id="myModalLabel">
									<spring:message
										code="admin.rpt_inv_stockout_allcat_period.jsp.alert"
										text="Alert!" />
								</h4>
							</div>
							<div class="modal-body"
								...
								<div style="text-align: center; font-size: 20px;">
									<spring:message
										code="admin.rpt_inv_stockout_allcat_period.jsp.cont_three"
							...
							<div class="modal-footer"
								...
								<button type="button"
									...
									data-dismiss="modal" class="btn btn-success">
									<spring:message
										code="admin.rpt_inv_stockout_allcat_period.jsp.ok" text="OK" />
								</button>
							</div>
						</div>
					</div>
