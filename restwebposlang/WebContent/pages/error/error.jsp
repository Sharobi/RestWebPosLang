    ...
    <div class="content-wrapper">
        <div class="container-fluid">
        	...
        	<div align="center" style="color: #fff; font-weight: bold;font-size: 16px">
        		<spring:message code="menuitem.jsp.OOPSErrorOccurred" text="OOPS Error Occurred" />!!!
        	</div>
        	<div align="center" style="color: #fff; font-weight: bold;font-size: 14px">
        		<spring:message code="menuitem.jsp.Cause" text="Cause" /> :${pageContext.exception}
        	</div>
        	<div align="center" style="color: #fff; font-weight: bold;font-size: 14px">
        		<spring:message code="menuitem.jsp.Details" text="Details" /> :${pageContext.exception}
