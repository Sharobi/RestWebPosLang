...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <![endif]-->
      <title>:. POS :: Advance Table Booking Management :.</title>
                              ...
                              <div class="table-responsive" style="background:#404040;">
                                 <table class="table table-striped table-bordered table-hover">
                                    <thead style="background:#404040; color:#FFF;">
                                       ...
                                       <th style="text-align:center;">
                                          <spring:message code="admin.advtblbookingmgnt.jsp.tblno" text="TABLE" />
                                       </th>
                                       <th style="text-align:center;">
                                       ...
                                       <c:if test="${! empty advanceTableBookingList }">
                                          <c:forEach items="${advanceTableBookingList}" var="advtblbooking">
                                             <tr style="background:#404040; color:#FFF;">
                                                ...
                                                <td align="center">
                                                <c:choose>
												  <c:when test="${advtblbooking.table_no!='0'}">
												     ${advtblbooking.table_no}
												  </c:when>
												  <c:otherwise>
												     ${advtblbooking.ordertype.orderTypeName}
												  </c:otherwise>
												</c:choose>
                                                </td>
                                                ...
                                                <%-- <td align="center"><a href="javascript:showadvtblbookingeditModal(${advtblbooking.id},&quot;${advtblbooking.table_no}&quot;,&quot;${advtblbooking.orderDate}&quot;,&quot;${advtblbooking.time}&quot;,&quot;${advtblbooking.customerName}&quot;,&quot;${advtblbooking.customerContact}&quot;,&quot;${advtblbooking.deliveryAddress}&quot;,${advtblbooking.noOfPersons},&quot;${advtblbooking.location}&quot;,${advtblbooking.storeCustomerId})"><input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_edit.png"></a></td> --%>
                                                ...
                                                <td align="center"><a href="javascript:showDetailadvtblbookingModal(${advtblbooking.id},&quot;${advtblbooking.table_no}&quot;,&quot;${advtblbooking.orderDate}&quot;,&quot;${advtblbooking.time}&quot;,&quot;${advtblbooking.customerName}&quot;,&quot;${advtblbooking.customerContact}&quot;,&quot;${advtblbooking.deliveryAddress}&quot;,${advtblbooking.noOfPersons},&quot;${advtblbooking.location}&quot;,&quot;${advtblbooking.orderNo}&quot;)"><input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_details.png"></a></td>
                     ...
                     <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                        <div style="text-align: left;font-size: 20px;">
                           ...
                           <table>
                              ...
                              <tr id="editadvbookingcustnoofpersontr">
                                 <td>
                                    <spring:message
                           ...
                           <table>
                              ...
                              <tr style="display:none;">
                               ...
                               <tr style="display:none;">
                                 <td>
                                    <spring:message
                                       code="accsetup.jsp.state" text="State" />
                                 </td>
                                 <td>:</td>
                                 <td><input id="advbookingcuststate" 
                                    style="margin-bottom: 2px; color: #222222; width: 95%; margin-bottom: 5px;"/></td>
                              </tr>
                              <tr id="advbookingcustnoofpersontr">
                                 <td>
                                    <spring:message
                                       code="admin.advtblbookingmgnt.jsp.noofperson" text="No.Of Persons" />
                                    <span style="color: #ff0000;">*</span>
                     ...
                     <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                        <div align="center" style="font-size: 20px;">
                           <table>
                              ...
                              <tr>
                                 <td style="padding: 5px 0px;">
                                    <spring:message code="admin.advtblbookingmgnt.jsp.selectedtable"
                                       text="Selected Table" />
                                 </td>
                                 <td width="5%">:</td>
				...
				<div class="modal-dialog" style="width: 276px; height: auto;">
					...
					<div class="modal-body" id="printDiv80"
						...
						<div
							...
							<table style="height: 50px; width: 100%;" id="orderAmtDetails">
								...
								<tr>
									<td><b><span
											style="font-weight: bold; font-size: 12px; font-family: sans-serif;"><spring:message
													code="admin.creditsale.jsp.billAmt" text="BILL AMT" /> :</span></b></td>
									<td
										style="text-align: right; font-size: 11px; font-family: sans-serif;"><b><span
											id="cashbillAmount80">00</span></b></td>
								</tr>
								<tr>
									<td><b><span
											style="font-weight: bold; font-size: 12px; font-family: sans-serif;"><spring:message
						...
						<div class="modal-footer" id="cashRemovePrint80"
							style="background: #ffffff; border-top: 1px solid #ffffff; padding: 10px; display:none;">
							<button type="button"
      ...
      <script type="text/javascript">
         ...
         // alert(ordertypevalue+"----"+id);
          ...
          $("#itemCodeSearch").removeAttr('disabled');
           text = $("#addOrderType").find("option:selected").text();
          }
          else{
           $("#edititemCodeSearch").removeAttr('disabled');
            text = $("#editOrderType").find("option:selected").text();
          }
          ...
          // alert(text);
           if(text == "Dine In" || text == "DINE IN" || text == "dine in"){
            if(id == 1){
            $("#selecttabletr").css("display", "");
            $("#advbookingcustnoofpersontr").css("display", ""); 
            }else{
         	  ...
         	  if(id == 1){
         	  $("#selecttabletr").css("display", "none");
         	  $("#advbookingcustnoofpersontr").css("display", "none"); 
         	  }
         	  else{
                     ...
                     .autocomplete(
                             {
                                 ...
                                 select : function(e, ui) {
                                         ...
                                         $("#advbookingcuststate").val(ui.item.cusstate);
