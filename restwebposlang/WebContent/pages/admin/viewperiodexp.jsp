        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
				<div class="col-md-12 col-sm-12" align="center">
                    <span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.viewdailyexp.jsp.selectVDFPE" text="Select Voucher Dates For Period Wise Expenditure" /></span>&nbsp;&nbsp;
                    ...
                    <input type="hidden" id="hiddatedailyExp" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />"> --%>
                    		 ...
                    		 <c:if test="${!empty fromdate}">
                    		 	<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.unpaidOrders.jsp.fromdate" text="From Date :" /></span>
                    			<input type="text" id="fromdateexpList" size="10" value="${fromdate}" />" 
                    			<c:set var="fromSpecificDate" value="${fromdate}" />
                    		</c:if>
                  
                    		<c:if test="${!empty todate}">
                    			<span style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.unpaidOrders.jsp.todate" text="To Date :" /></span>
                   ...
                   <a href="javascript:showPeriodWiseExp(document.getElementById('fromdateexpList').value,document.getElementById('todateexpList').value,${sessionScope.loggedinUser.storeId})" class="btn btn-success" style="background:#FF8576;;margin-bottom: 3px; padding: 2px 12px;"><spring:message code="admin.viewdailyexp.jsp.view" text="View" /></a> 
                </div>
                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                            ...
                                            <spring:message code="admin.rpt_cat_sales.jsp.cont_three" text="Given From Date is Greater than To Date!" />
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button"   onclick="javascript:showCurrentDateExp(${sessionScope.loggedinUser.storeId})"  style="background: #72BB4F;font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="unpaidorder.jsp.OK" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            ...
                                            <button type="button" onclick="javacsript:deleteDailyExpenditure()" style="background: #72BB4F;font-weight: bold;width: 25%;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.invtypemgnt.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>    
                              <div class="modal fade" data-backdrop="static" id="alertdailyexpdataopModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button" style="background: #72BB4F;font-weight: bold;width: 25%" onclick="location.href='${pageContext.request.contextPath}/expendituremgmt/viewdailyexpenditure.htm'" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.invtypemgnt.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
