                                    	...
                                    	<c:if test="${! empty menusubcategorylist }">
                                    		<c:forEach items="${menusubcategorylist}" var="menusubcategoy">
                                    			<tr style="background:#404040; color:#FFF;">
                                    				...
                                    				<td align="center">
                                    				 <c:choose>
                                                        <c:when test="${fn:containsIgnoreCase(menusubcategoy.menuCategoryName, 'REQUEST EXTRA') }">
                                                        </c:when>
                                                        <c:otherwise>
                                                                 <a href="javascript:shownmenusubcateditModal(${menusubcategoy.id},&quot;${menusubcategoy.menuCategoryName}&quot;,&quot;${menusubcategoy.bgColor}&quot;)"> <input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_edit.png"></a>
                                                        </c:otherwise>
                                                     </c:choose>
                                    				</td>
                                           			<td align="center">
                                                        ...
                                                        <c:otherwise>
                                                                 <a href="javascript:showConfirmdeleteSubCatModal(${menusubcategoy.id},&quot;${menusubcategoy.menuCategoryName}&quot;,&quot;${menusubcategoy.bgColor}&quot;)"><input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_delete.png"></a>
                                                        </c:otherwise>
                                                     </c:choose>
                                           			</td>
                                            		...
                                            		<c:choose>
                                                        ...
                                                        <c:otherwise>
                                                                <a href="javascript:showSubCatKOTPrinterModal(${menusubcategoy.id},&quot;${menusubcategoy.menuCategoryName}&quot;)"><input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_tprinter.png"></a>
                                                        </c:otherwise>
                                                     </c:choose>
                                            		</td>
                                            		</c:if>
