...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS :: Delivery Boy Management :.</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10">
                <div class="col-md-10 col-sm-10">
                    <div style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.deliveryboymgnt.jsp.deliveryboy" text="DELIVERY BOYS" /></div> 
                </div>
                                    	...
                                    	<c:if test="${! empty deliveryBoyList }">
                                    		<c:forEach items="${deliveryBoyList}" var="deliveryboy">
                                    			<tr style="background:#404040; color:#FFF;">
                                    				...
                                    				<%-- <fmt:formatDate pattern="yyyy-MM-dd" value="${deliveryboy.DOB}" var="strDOB"/>
                                    				<fmt:formatDate pattern="yyyy-MM-dd" value="${deliveryboy.DOJ}" var="strDOJ"/>  --%>
           ...
           <!-- modal starts -->
                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        <div class="modal-header" style="background: #939393;color: #fff;border-bottom: 1px solid #939393;">
                                            ...
                                            <h4 class="modal-title" style="font-size: 18px;font-weight: bold;" id="myModalLabel"><spring:message code="admin.deliveryboymgnt.jsp.addDeliveryBoy" text="Add Delivery Boy" /></h4>
                                        </div>
                            ...
                            <div class="modal fade" data-backdrop="static" id="deliveryBoyEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        <div class="modal-header" style="background: #939393;color: #fff;border-bottom: 1px solid #939393;">
                                            <h4 class="modal-title" style="font-size: 18px;font-weight: bold;" id="myModalLabel"><spring:message code="admin.deliveryboymgnt.jsp.editDeliveryBoy" text="Edit Delivery Boy" /></h4>
                                        </div>
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div style="text-align: left;font-size: 20px;">
                                        	<input type="hidden" id="editdelboyidContId" value="">
                                            	<table>
                                            		<tr>
                                            			<td><spring:message code="admin.deliveryboymgnt.jsp.deliveryboyName" text="NAME" /></td>
                                            			<td>:</td>
                                            		...
                                            		<tr>
                                            			<td><spring:message code="admin.deliveryboymgnt.jsp.delboyPhone" text="PHONE NUMBER" /></td>
                                            			<td>:</td>
                            ...
                            <div class="modal fade" data-backdrop="static" id="deliveryBoyDetailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        <div class="modal-header" style="background: #939393;color: #fff;border-bottom: 1px solid #939393;">
                                            <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> -->
                                            <h4 class="modal-title" style="font-size: 18px;font-weight: bold;" id="myModalLabel"><spring:message code="admin.deliveryboymgnt.jsp.deliveryBoyDetails" text="Delivery Boy Details" /></h4>
                                        </div>
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
