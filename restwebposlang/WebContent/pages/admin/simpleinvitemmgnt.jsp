...
<body>
			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<div class="col-md-5 col-sm-5">
						<div style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message code="admin.simpleinvitemmgnt.jsp.simpleInvItem" text="SIMPLE INVENTORY ITEMS" /></div>
					</div>
					<div class="col-md-5 col-sm-5">
						<input type="text" id="invitemSearch" placeholder="<spring:message code="admin.simpleinvitemmgnt.jsp.search" text="SEARCH" />"> <a href="javascript:loadinvItems(document.getElementById('autocompleteinvItemId').value,1)" class="btn btn-success" style="background: #78B626; margin-bottom: 3px;"><spring:message code="admin.simpleinvitemmgnt.jsp.go" text="Go" /></a> <input type="hidden" value="" id="autocompleteinvItemId">
					</div>
					<div class="col-md-2 col-sm-2">
						<a href="javascript:showinvitemaddModal()" class="btn btn-success" style="width: 80px; background: #78B626; margin-bottom: 3px;"><spring:message code="admin.simpleinvitemmgnt.jsp.add" text="ADD" /></a>
					</div>
									...
									<div class="table-responsive" style="background: #404040;">
										<table class="table table-striped table-bordered table-hover">
											<thead style="background: #404040; color: #FFF;">
												...
												<th style="text-align: center;"><spring:message code="admin.simpleinvitemmgnt.jsp.id" text="ID" /></th>
												<th style="text-align: center;"><spring:message code="admin.simpleinvitemmgnt.jsp.code" text="CODE" /></th>
												<th style="text-align: center;"><spring:message code="admin.simpleinvitemmgnt.jsp.name" text="NAME" /></th>
												<th style="text-align: center;"><spring:message code="admin.simpleinvitemmgnt.jsp.edit" text="EDIT" /></th>
												<th style="text-align: center;"><spring:message code="admin.simpleinvitemmgnt.jsp.delete" text="DELETE" /></th>
												<th style="text-align: center;"><spring:message code="admin.simpleinvitemmgnt.jsp.details" text="DETAILS" /></th>
						...
						<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
							<div style="text-align: left; font-size: 20px;">
								...
								<table>
									...
									<tr>
										<td><spring:message code="admin.simpleinvitemmgnt.jsp.stockable" text="STOCKABLE" /></td>
										<td>:</td>
										<td><select id="addinvitemstockable" style="margin-bottom: 2px;color: #222222;">
								...
								<table>
                                   ...
                                   <!--  <input type="text" id="editinvitemunitContId" style="text-align:left; width:95%; color: #222222;margin-bottom: 5px;" />  --> <!-- off in 19th april 2018 -->
									...
									<tr>
										<td><spring:message code="admin.simpleinvitemmgnt.jsp.stockable" text="STOCKABLE" /></td>
										<td>:</td>
										<td><select id="editinvitemstockable" style="margin-bottom: 2px;color: #222222;">
                                            					 <option value="Y">YES</option>
                                                                 <option value="N">NO</option>
                                            </select></td>
									</tr>
				...
				<div class="modal-dialog" style="margin: 100px auto;">
					<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
						<div class="modal-header" style="background: #939393; color: #fff; border-bottom: 1px solid #939393;">
							...
							<h4 class="modal-title" style="font-size: 18px; font-weight: bold;" id="myModalLabel"><spring:message code="admin.simpleinvitemmgnt.jsp.confirmation" text="Confirmation!" /></h4>
						</div>
						<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
							<input type="hidden" id="deletecallsimpleinventory" value="1">
							<div style="text-align: center; font-size: 20px;">
								<spring:message code="admin.simpleinvitemmgnt.jsp.areYouSure" text="Are you sure?" /> <input type="hidden" id="moddeleteconfirminvitemContId" value="">
							</div>
						</div>
						<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
							<button type="button" style="background: #F60; font-weight: bold; width: 25%;" class="btn btn-warning" data-dismiss="modal"><spring:message code="admin.simpleinvitemmgnt.jsp.cancel" text="CENCEL" /></button>
							<button type="button" onclick="javascript:deleteInventoryItem()" style="background: #72BB4F; font-weight: bold; width: 25%;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.simpleinvitemmgnt.jsp.ok" text="OK" /></button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal fade" data-backdrop="static" id="invitemDetailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
				<div class="modal-dialog" style="margin: 100px auto;">
					<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
						<div class="modal-header" style="background: #939393; color: #fff; border-bottom: 1px solid #939393;">
							<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> -->
							<h4 class="modal-title" style="font-size: 18px; font-weight: bold;" id="myModalLabel"><spring:message code="admin.simpleinvitemmgnt.jsp.simpleInvItemDetails" text="Simple Inventory Item Details" /></h4>
						</div>
						<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
							<div align="center" style="font-size: 20px;">
								<table>
									<tr>
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.itemId" text="ITEM ID" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemidTd"></td>
									</tr>
									<tr>
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.itemName" text="ITEM NAME" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemnameTd"></td>
									</tr>
									<tr>
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.itemCode" text="ITEM CODE" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemcodeTd"></td>
									</tr>
									<tr>
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.itemType" text="ITEM TYPE" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemtypeTd"></td>
									</tr>
									<tr style="display: none;">
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.qty" text="QUANTITY" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemqtyTd"></td>
									</tr>
									<tr >
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.unit" text="UNIT" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemunitTd"></td>
									</tr>
									<tr style="display: none;">
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.rate" text="RATE" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemrateTd"></td>
									</tr>

									<tr>
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.vendorName" text="VENDOR NAME" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemvendornameTd"></td>
									</tr>
									<tr>
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.stockable" text="STOCKABLE" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemstockableTd"></td>
									</tr>
									<tr style="display: none;">
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.shippingCharge" text="SHIPPING CHARGE" /></td>
										<td width="5%">:</td>
										<td id="moddetailinvitemshippingTd"></td>
									</tr>
									<tr style="display: none;">
										<td style="padding: 5px 0px;"><spring:message code="admin.simpleinvitemmgnt.jsp.dailyReq" text="DAILY REQUIREMENT" /></td>
										<td width="5%">:</td>
						...
						<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
							<button type="button" style="background: #72BB4F; font-weight: bold; width: 25%" class="btn btn-success" data-dismiss="modal"><spring:message code="admin.simpleinvitemmgnt.jsp.ok" text="OK" /></button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal fade" data-backdrop="static" id="alertnoInvItemFoundModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
				<div class="modal-dialog" style="margin: 100px auto;">
					<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
						...
						<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
							<div style="text-align: center; font-size: 20px;"><spring:message code="admin.simpleinvitemmgnt.jsp.noInvItemFound" text="No inventory item found!" /></div>
						</div>
						<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
							<button type="button" style="background: #72BB4F; font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.simpleinvitemmgnt.jsp.ok" text="OK" /></button>
						</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		function showinvitemeditModal( id,
			...
			document.getElementById('editinvitemstockable').value=isstockable;
			document.getElementById('edittax').value = tax;
			 if(tax == 'Y'){
				...
				document.getElementById('editinvitemstockable').value = "Y";
	...
	function showDetailInvItemModal(id,
			...
			document.getElementById('moddetailinvitemstockableTd').innerHTML = isstockable;
			var vendoridarray = [];
			var vendornamearray = [];
			var vendorname = "";
			<c:forEach items="${invVENDORList}" var="vendor" varStatus="loop">
