        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10" id="menumgntContainerId">
                ...
                <c:if test="${! empty alllanguage }">
                				<select id="changelangId" style="color:#000; width: 75px;" onchange="javascript:getitemfortranslationwithlang(this.value)">
               ...
               <%--  <div class="col-md-2 col-sm-2">
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <div style="max-height: 450px;overflow-y:auto; "> 
                            ...
                            <div class="table-responsive" style="background:#404040;">
                                <table id= "translatemenuitem"class="table table-striped table-bordered table-hover">
                                    <thead style="background:#404040; color:#FFF;">
                                            ...
                                            <th style="text-align:center;"><spring:message code="admin.menuitemtranslation.jsp.description" text="DESCRIPTION" /></th>
                                            <th style="text-align:center;"><spring:message code="admin.menuitemtranslation.jsp.translatedescription" text="TRANSLATE DESCRIPTION" /></th>
                                    	...
                                    	<c:if test="${! empty allmenuTree }">
                                    		<%-- <c:forEach items="${allmenuTree.menucategory}" var="menucategory">
                                    			<c:forEach items="${menucategory.menucategory}" var="menusubcategory"> --%>
                                    				<c:forEach items="${allmenuTree}" var="menuitems">
                                    					<tr style="background:#404040; color:#FFF;">
                                    						<input type="hidden" name="id" class="translationid" value="${menuitems.id}">
                                    						<td align="center"><input type="checkbox" name="checkbox" class="translateMenuitemchk" value="${menuitems.itemId}"></td>
                                    						 <!-- onclick="highlight_row(this, 'orange');" -->
                                    						<td class="translateMenuitemId" align="center">${menuitems.itemId}</td>
                                    						<td>${menuitems.englishName}</td>
                                    						<%-- <td align="center">
                                    						...
                                    						<td align="center"><input class="translateMenuitemName"type="text" style="color:#000000;" name="englishName" autofocus="autofocus" value="${menuitems.name}"></td>
                                           					<td align="center" width="30%">${menuitems.englishDesc}</td>
                                           					<td align="center">
                                            			<textarea id="translateMenuitemDescription" class="translateMenuitemDescription"  rows="2" style="margin-bottom: 2px;color: #222222;width: 95%;">${menuitems.description}</textarea>
                                            			</td>
                                            				<%-- <td align="center"><input class="translateMenuitemDescription"type="text" style="color:#000000;" name="englishName" autofocus="autofocus" value="${menuitems.description}"></td> --%>
                                            				<%-- <td align="center">
                                            				...
                                            				<%-- <td align="center">${menuitems.englishDesc}align="center">${menucategory.menuCategoryName}</td>
                                            				<td align="center">${menuitems.englishDesc}align="center">${menusubcategory.menuCategoryName}</td> --%>
                                            				<%-- <c:if test="${sessionScope.loggedinStore.kotPrintType=='item'}">
                                            				<td align="center">
                                            					<c:if test="${! fn:containsIgnoreCase(menucategory.menuCategoryName, 'SPECIAL NOTE') }">
                    ...
                    <button type="button" onclick="javascript:translatemenuItem()" style="background: #72BB4F;font-weight: bold;width: 25%"  class="btn btn-success"><spring:message code="admin.menuitems.jsp.create" text="CREATE" /></button>
                </div>
                </div>
                </div>
                            ...
                            <div class="modal fade" data-backdrop="static" id="alertmenuitemdataopModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button" onclick="location.href='${pageContext.request.contextPath}/menutranslation/loadmenuitemtotranslate.htm'" style="background: #72BB4F;font-weight: bold;width: 25%"  data-dismiss="modal" class="btn btn-success"><spring:message code="admin.menuitems.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                         ...
                         <div class="modal fade" data-backdrop="static" id="alertmenuitemdataopModal_cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button class="btn btn-warning" type="button" style="background:#F60;font-weight: bold;width: 25%" data-dismiss="modal"><spring:message code="admin.menuitems.jsp.pl" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>   
