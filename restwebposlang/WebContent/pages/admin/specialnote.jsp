                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        <div class="modal-header" style="background: #939393;color: #fff;border-bottom: 1px solid #939393;">
                                            ...
                                            <h4 class="modal-title" style="font-size: 18px;font-weight: bold;" id="myModalLabel"><spring:message code="admin.specialnote.jsp.addSpecialItem" text="Add Special Note for " /> ${itemnameforspnote}</h4>
                                        </div>
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button" style="background:#F60;font-weight: bold;width: 25%" class="btn btn-warning" data-dismiss="modal"><spring:message code="admin.specialnote.jsp.cancel" text="CANCEL" /></button>
                                            <c:if test="${! empty allsplnoteTree.menucategory }">
                                            <button type="button" onclick="javascript:addspecialNote();" style="background: #72BB4F;font-weight: bold;width: 25%"  class="btn btn-success"><spring:message code="admin.specialnote.jsp.save" text="SAVE" /></button>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
