...
<body>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<div class="col-md-6 col-sm-6">
						...
						<spring:message code="admin.expenditure.jsp.expenditure" text="EXPENDITURE" />
						</div>
										...
										<table class="table  table-bordered" id="tbl">
											<thead>
												<tr
													...
													<td align="center" width="10%"><spring:message code="admin.expenditure.jsp.exptype" text="TYPE" /></td>
													
													<td align="center" width="10%"><spring:message code="admin.expenditure.jsp.date" text="Date" /></td>
													<td align="center" width="15%"><spring:message code="admin.expenditure.jsp.voucherNo" text="Voucher No." /></td>
													<td align="center" width="10%"><spring:message code="admin.expenditure.jsp.vendorName" text="Vendor Name" /></td>
													<td align="center" width="20%"><spring:message code="admin.expenditure.jsp.particulars" text="Particulars" /></td>
													<td align="center" width="10%"><spring:message code="admin.expenditure.jsp.amount" text="Amount" /></td>
													<td align="center" width="5%"><spring:message code="admin.expenditure.jsp.taxRate" text="Tax(%)" /></td>
													<td align="center" width="10%"><spring:message code="admin.expenditure.jsp.taxAmt" text="Tax Amt" /></td>
													<td align="center" width="10%"><spring:message code="admin.expenditure.jsp.netAmt" text="Net Amt" /></td>
												</tr>
											</thead>
											<tbody id="tbdy">
												<tr class="item"
                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        <div class="modal-header" style="background: #939393;color: #fff;border-bottom: 1px solid #939393;">
                                            ...
                                            <h4 class="modal-title" style="font-size: 18px;font-weight: bold;" id="myModalLabel"><spring:message code="admin.expenditure.jsp.alert" text="Alert!" /></h4>
                                        </div>
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div style="text-align: center;font-size: 20px;">
                                           		<spring:message code="admin.expenditure.jsp.all_fields_resuired" text="All fields are required" />
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button"  style="background: #72BB4F;font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.expenditure.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            				...
            				<div class="modal fade" data-backdrop="static" id="expGreaterDateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div style="text-align: center;font-size: 20px;">
                                            <spring:message code="admin.expenditure.jsp.cont_one" text="Given date is greater than today's date!" />
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button"  style="background: #72BB4F;font-weight: bold;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.expenditure.jsp.ok" text="OK" /></button>
           ...
           <!-- modal ends -->
            <!-- modal starts -->
           <div class="modal fade" data-backdrop="static" id="dailyexpmsgmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"   aria-hidden="true" style="display: none;">
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				<div class="modal-header" style="background: #939393; color: #fff; border-bottom: 1px solid #939393;">
