...
<body>
                                ...
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                           ...
                                           <button type="button" id="singlepaybtn" onclick="javascript:cr_vendorpayByCash(document.getElementById('cr_vendorcashtenderAmt').value)" style="width:25%; background: #72BB4F;font-weight: bold;" class="btn btn-success">PAY</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" data-backdrop="static" id="totcr_vendorcashModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                           <button type="button" style="width:25%; background:#F60;font-weight: bold;" class="btn btn-warning" data-dismiss="modal">CANCEL</button>
                                           <button type="button" id="totalpaybtn" onclick="javascript:totcr_vendorpayByCash(document.getElementById('totcr_vendorcashtenderAmt').value)" style="width:25%; background: #72BB4F;font-weight: bold;" class="btn btn-success"><span id="totvendorcashpaySpinner" style="display: none;"><i class="fa fa-spinner fa-spin"></i></span>&nbsp;PAY</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
   ...
   var BASE_URL="${pageContext.request.contextPath}";
	...
	$(document).ready(function(){
		if (is_Acc=='Y') {
			getvendorledger_pur('CIH',0,0,1);// for cash in hand
			
			if(document.getElementById('creditvendoridContId').value>0)
				{
				getvendorledger_pur('SCR',0,document.getElementById('creditvendoridContId').value,2);// for creditor
				}
		}
