				 ...
				 <input type="hidden" id="service_charge_ledger_idf" value="0">
					<div class="col-md-12 col-sm-12" align="center">
						<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
								...
								text="Select Period For Unpaid Orders" /></span>&nbsp;&nbsp;&nbsp;&nbsp;

						<c:if test="${!empty fromdate}">
							<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
									code="admin.unpaidOrders.jsp.fromdate" text="From Date :" /></span>
						...
						<c:if test="${!empty todate}">
							<span style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message
									code="admin.unpaidOrders.jsp.todate" text="To Date :" /></span>
										...
										<c:forEach items="${allunpaidOrderList}" var="unpaidOrders"
											...
											<div class="panel panel-default" id="${unpaidOrders.id}"
												...
												<div class="panel-heading"
													style="margin-bottom: 8px; color: #000; background-color: #ccd1ce;">
																...
																<div class="panel-body" style="overflow-y: auto;">
																	<div class="table-responsive"
																		...
																		<table class="table table-striped table-bordered">
																			<thead>
																				<th><spring:message code="order.jsp.SL"
																						text="SL" /></th>
																				<th><spring:message code="order.jsp.NAME"
																						text="NAME" /></th>
																				...
																				<th><spring:message code="order.jsp.TOTAL"
																						text="TOTAL" /></th>
																				<th><spring:message
																						code="unpaidorder.jsp.DISCNT" text="DISCNT" /></th>
																				<th><spring:message code="order.jsp.RATE"
																						text="RATE" /></th>
																				<!-- 	<th>SL</th>
        																			<th>NAME</th>
																			...
																			<tbody>
																				<c:if test="${! empty allunpaidOrderList}">
																					<c:set var="presentOrderID"
																						value="${unpaidOrders.id}" />
																			...
																			<c:forEach items="${allunpaidOrderList}"
																				...
																				<c:if test="${presentOrderID == iteratingOrderID}">
																				 ...
																				 <c:if test="${custDisc!=0.0}">
																					...
																					<c:if
																						test="${unpaidOrder.orderBill.customerDiscount!=0.0}">
																						<c:set var="custDisc"
																				...
																				test="${fn:containsIgnoreCase(unpaidOrder.isDiscountAdded, 'Y') }">
																					...
																					<%--  <c:set var="totVat">
																								<fmt:formatNumber type="number" groupingUsed="false" minFractionDigits="2" maxFractionDigits="2" value="${(totRate+serviceCharge)*unpaidOrders.orderitem[0].vat/100}" />
																							</c:set>
