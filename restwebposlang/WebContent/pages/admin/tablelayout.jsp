		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<div class="col-md-10 col-sm-10">
						<div style="color: #FFF; font-size: 16px; font-weight: bold;"><spring:message code="admin.tablelayout.jsp.tableLayout" text="TABLE LAYOUT" /></div>
						<input type="hidden" id="hidstoreid" value="${sessionScope.loggedinStore.id}">
					</div>
					<div class="col-md-2 col-sm-2" id="layoutsavebutdiv">
						<a href="javascript:savetableposition()" class="btn btn-success" style="width: 80px; background: #41A1E3; margin-bottom: 3px;"><spring:message code="admin.tablelayout.jsp.save" text="Save" /></a>
					</div>
												...
												<div class="table-holder">
													<div class="postable enabled">
														...
														<div class="table-info">
															...
															<div class="table-subinfo">${tables.seatingCapacity}<spring:message code="admin.tablelayout.jsp.seaters" text="SEATERS" /></div>
				...
				<div class="modal-dialog" style="margin: 100px auto;">
					<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
						...
						<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
							<button type="button" onclick="javascript:location.href='${pageContext.request.contextPath}/tablemgnt/loadtablelayout.htm'" style="background: #72BB4F; font-weight: bold; width: 25%;" data-dismiss="modal" class="btn btn-success"><spring:message code="admin.tablelayout.jsp.ok" text="OK" /></button>
						</div>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		function savetableposition() {
			...
			$('.table-holder').each(function() {
				...
				tabledetails.xPos = parseInt(xpos - (widthleftpanel + 2));
				tabledetails.yPos = parseInt(ypos - (133 + heightsavebut + 12));
