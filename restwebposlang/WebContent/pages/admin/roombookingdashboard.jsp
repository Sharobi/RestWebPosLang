...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>:. POS :: Room Booking Dashboard:.</title>
...
<body>
					...
					<div class="row" style="text-align: center;">
						<div class="col-lg-5 col-xs-12">
							<label for="startdate" style="color: white;">From:</label> <input
								type="text" class="" id="startdate" onchange="getRoomBookingDashBoardData()" style="text-align: center;"
								size=10
								value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
						</div>
						<div class="col-lg-4 col-xs-12">
							<label for="enddate" style="color: white;">To:</label> <input
								type="text" class="" id="enddate" onchange="getRoomBookingDashBoardData()"
											...
											<div class="test-heading">
												<div class="row">
													...
													<div class="col-xs-9 text-right">
														<div>
															<b class="boxheading">Total Booking</b>
														</div>
													</div>
												</div>
												<div class="row">
										...
										<div class="col-lg-2 col-xs-12 test"
											...
											<div class="test-heading">
												<div class="row">
													...
													<div class="col-xs-9 text-right">
														<div>
															<b class="boxheading text-nowrap">Total Booking Sold</b>
														</div>
													</div>
												</div>
												<div class="row">
										...
										<div class="col-lg-2 col-xs-12  test"
											...
											<div class="test-heading">
												<div class="row">
													...
													<div class="col-xs-9 text-right">
														<div>
															<b class="boxheading">Paid Bookings</b>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-xs-12 text-right" style="color:white;font-weight:bold">
														<br> <span id="totpaidorder" class="count" style="color:white;font-weight:bold">0.0</span>
														   (<span id="totpaidorderNo" class="count" style="color:white;font-weight:bold">0</span>&nbsp;Bookings)
													</div>
												</div>
											</div>
										</div> 
										 <div class="col-lg-2 col-xs-12 test"
											...
											<div class="test-heading">
												<div class="row">
													...
													<div class="col-xs-9 text-right">
														<div>
															<b class="boxheading">Credit Booking</b>
														</div>
													</div>
												</div>
												<div class="row" style="color:white;font-weight:bold">
													<div class="col-xs-12 text-right">
														<br> <span id="totcreditbooking" class="count" style="color:white;font-weight:bold">0.0</span>
														(<span id="totcreditbookingNo" class="count" style="color:white;font-weight:bold">0</span>&nbsp;Bookings)
   ...
   <script type="text/javascript">
	...
	<script>
         ...
         function getRoomBookingDashBoardData(){
        	//alert("hh");
         	getBoxData();
         	getAllDataPie1();
         	getAllDataPie2();
