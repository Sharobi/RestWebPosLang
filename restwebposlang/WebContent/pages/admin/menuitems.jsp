...
<body>
        ...
        <div class="row">
           ...
           <div class="col-md-10 col-sm-10" id="menumgntContainerId">
				<div class="col-md-5 col-sm-5">
                    <div style="color:#FFF; font-size:16px; font-weight:bold;"><spring:message code="admin.menuitems.jsp.menuItem" text="MENU ITEMS" /></div> 
                </div>
                <div class="col-md-5 col-sm-5">
                   <input type="text" id="itemSearch" placeholder="<spring:message code="admin.menuitems.jsp.search" text="SEARCH" />">
                            ...
                            <div class="table-responsive" style="background:#404040;">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead style="background:#404040; color:#FFF;">
                                            ...
                                            <th style="text-align:center;"><spring:message code="admin.menuitems.jsp.rate" text="RATE" /></th>
                                            <th style="text-align:center;"><spring:message code="admin.menuitems.jsp.splNote" text="SPL NOTE" /></th>
                                            <th style="text-align:center;"><spring:message code="admin.menuitems.jsp.edit" text="EDIT" /></th>
                                    ...
                                    <tbody>
                                    			...
                                    			<c:forEach items="${menucategory.menucategory}" var="menusubcategory">
                                    				<c:forEach items="${menusubcategory.items}" var="menuitems">
                                    					<tr style="background:#404040; color:#FFF;">
                                    						...
                                    						<td align="center">
                                    							<fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${menuitems.price}"></fmt:formatNumber>
                                    						</td>
                                    						<td align="center">
                                    						<c:if test="${! fn:containsIgnoreCase(menucategory.menuCategoryName, 'SPECIAL NOTE') }">
                                    							<a href="javascript:clickonmenuItems(${menuitems.id},&quot;${menuitems.name}&quot;)" class="btn btn-success"><spring:message code="admin.menuitems.jsp.splNote" text="SPL NOTE" /></a>
                                    						</c:if>
                                    						</td>
                                    						<td align="center"><a href="javascript:shownmenuitemseditModal(${menucategory.id},&quot;${menucategory.menuCategoryName}&quot;,${menusubcategory.id},&quot;${menusubcategory.menuCategoryName}&quot;,${menuitems.id},&quot;${menuitems.name}&quot;,&quot;${menuitems.description}&quot;,${menuitems.price},${menuitems.vat},${menuitems.serviceTax},'${menuitems.veg}','${menuitems.spicy}','${menuitems.promotionFlag}',&quot;${menuitems.promotionDesc}&quot;,${menuitems.promotionValue},${menuitems.cookingTimeInMins},'${menuitems.production}','${menuitems.unit}','${menuitems.spotDiscount}','${menuitems.isKotPrint}')"> <input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_edit.png"></a></td>
                                        ...
                                        <c:if test="${!empty singleMenuItem}">
                                        	<tr style="background:#404040; color:#FFF;">
                                            				...
                                            				<td align="center"><a href="javascript:shownmenuitemsdetailModal(${singleMenuItem.menucatId},&quot;${singleMenuItem.menucatName}&quot;,${singleMenuItem.submenucatId},&quot;${singleMenuItem.submenucatName}&quot;,${singleMenuItem.id},&quot;${singleMenuItem.name}&quot;,&quot;${singleMenuItem.description}&quot;,${singleMenuItem.price},${singleMenuItem.vat},${singleMenuItem.serviceTax},'${singleMenuItem.veg}','${singleMenuItem.spicy}','${singleMenuItem.promotionFlag}',&quot;${singleMenuItem.promotionDesc}&quot;,${singleMenuItem.promotionValue},${singleMenuItem.cookingTimeInMins},'${singleMenuItem.production}','${singleMenuItem.unit}','${singleMenuItem.spotDiscount}','${singleMenuItem.isKotPrint}','${menuitems.code}')"><input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_details.png"></a></td>
                            ...
                            <div class="modal fade" data-backdrop="static" id="menuitemEditModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        	...
                                        	<div style="text-align: left;font-size: 18px;">
                                            	...
                                            	<table>
                                            		...
                                            		<tr>
                                            			...
                                            			<td>:</td>
                                            			<td>
                                            				<select id="modeditmenuitemsKotPrint" style="margin-bottom: 2px;color: #222222;">
                                            					 <option value="Y">YES</option>
                                                                 <option value="N">NO</option>
                                            				</select>
                                            			</td>
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button" onclick="javascript:cancelMenuItems()" style="background:#F60;font-weight: bold;width: 25%" class="btn btn-warning" data-dismiss="modal"><spring:message code="admin.menuitems.jsp.cancel" text="CANCEL" /></button>
                                        ...
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div align="center" style="font-size: 18px;">
                                            	<table>
                                            		...
                                            		<tr>
                                            			<td style="padding: 2px 0px;"><spring:message code="admin.menuitems.jsp.code" text="CODE" /></td>
                                            			<td width="5%">:</td>
                                            		...
                                            		<tr>
                                            			<td style="padding: 2px 0px;"><spring:message code="admin.menuitems.jsp.kotprint" text="KOT PRINT" /></td>
                                            			<td width="5%">:</td>
                                            			<td id="moddetailmenuitemskotprint"></td>
                                            		</tr>
                                            	</table>
                            ...
                            <div class="modal fade" data-backdrop="static" id="alertmenuitemdataopModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog" style="margin: 100px auto;">
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                                            <button type="button" onclick="location.href='${pageContext.request.contextPath}/menumgnt/loadmenuitems.htm'" style="background: #72BB4F;font-weight: bold;width: 25%"  data-dismiss="modal" class="btn btn-success"><spring:message code="admin.menuitems.jsp.ok" text="OK" /></button>
                                        </div>
                                    </div>
                                </div>
                            </div> 
   ...
   function shownmenuitemseditModal(catid,catname,subcatid,subcatname,id,name,desc,rate,vat,stax,type,spicy,promo,promodesc,promovalue,cookingtime,production,unit,spotDisc,isKotPrint)
   {
	   ...
	   document.getElementById('modeditmenuitemsKotPrint').value=isKotPrint;
   ...
   function shownmenuitemsdetailModal(catid,catname,subcatid,subcatname,id,name,desc,rate,vat,stax,type,spicy,promo,promodesc,promovalue,cookingtime,production,unit,spotDisc,isKotPrint,code)
   {
	   ...
	   document.getElementById('moddetailmenuitemskotprint').innerHTML=isKotPrint;
