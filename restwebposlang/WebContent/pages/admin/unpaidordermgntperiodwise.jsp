...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <![end if]-->
      <title>:. POS :: Unpaid Orders Period Wise :.</title>
   ...
   <body>
      ...
      <div class="content-wrapper">
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-md-10 col-sm-10">
                  ...
                  <div class="col-md-12 col-sm-12" align="center">
                     <span style="color: #FFF; font-size: 16px; font-weight: bold;">
                        <spring:message
                           code="admin.unpaidOrders.jsp.periodForUnpaidOrders"
                           text="Select Period For Unpaid Orders" />
                     </span>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <c:if test="${!empty fromdate}">
                        <span style="color: #FFF; font-size: 16px; font-weight: bold;">
                           <spring:message
                              code="admin.unpaidOrders.jsp.fromdate" text="From Date :" />
                        </span>
                        <input type="text" id="fromdateunpaidorderList" size="10"
                           value="${fromdate}" />"
                     ...
                     <c:if test="${!empty todate}">
                        <span style="color: #FFF; font-size: 16px; font-weight: bold;">
                           <spring:message
                              code="admin.unpaidOrders.jsp.todate" text="To Date :" />
                        </span>
                        <input type="text" id="todateunpaidorderList" size="10"
                           value="${todate}" />"
                     ...
                     <input type="hidden" id="hiddenunpaidorderList"
                        value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />">
                     <a
                        href="javascript:showunpaidOrdersListPeriodWise(document.getElementById('fromdateunpaidorderList').value,document.getElementById('todateunpaidorderList').value,${sessionScope.loggedinUser.storeId})"
                        class="btn btn-success"
                        style="background: #FE2E64; margin-bottom: 3px;">
                        <spring:message
                           code="admin.taxmgnt.jsp.submit" text="SUBMIT" />
                     </a>
                     <input type="checkbox" id="selectall" class="checkBoxall" >
                     <a href="javascript:bulkPay(${sessionScope.loggedinUser.storeId})"
                        class="btn btn-success" style="background: #FE2E64; margin-bottom: 3px;">
                        <spring:message
                           code="order.jsp.PAY" text="PAY" />
                     </a>
                  </div>
                  <div class="col-md-12 col-sm-12">
                     <div id="daytimewiseunpaidorderContainerId" style="overflow-y:auto;height:500px;">
                                                      ...
                                                      <div class="table-responsive"
                                                         ...
                                                         <table class="table table-striped table-bordered">
                                                            <thead>
                                                               <th style="text-align: center;">
                                                                  <spring:message code="order.jsp.SL" text="SL" />
                                                               </th>
                                                               <th style="text-align: center;">
                                                                  <spring:message code="order.jsp.NAME" text="NAME" />
                                                               </th>
                                                               <th style="text-align: center;">
                                                                  <spring:message code="order.jsp.QUANTITY" text="QUANTITY" />
                                                               </th>
                                                               <th style="text-align: center;">
                                                                  <spring:message code="order.jsp.RATE" text="RATE" />
                                                               </th>
                                                               <th style="text-align: center;">
                                                         ...
                                                         <c:if test="${! empty allunpaidOrderList}">
                                                            <c:forEach items="${allunpaidOrderList}" var="unpaidOrder">
                                                               <c:set var="iteratingOrderID" value="${unpaidOrder.id}" />
                                                               <c:if test="${presentOrderID == iteratingOrderID}">
                                                                  <c:set var="iteratingOrderTypeServcharge" value="${unpaidOrder.orderBill.serviceChargeRate}"></c:set>
                                                               ...
                                                               <c:if
                                                                  ...
                                                                  <c:if test="${iteratingOrderTypeServcharge!=0.0}">
                                                                     ...
                                                                     <div id="schrgId"
                                                                        ...
                                                                        <fmt:formatNumber type="number"
                                                                           groupingUsed="false" minFractionDigits="2"
                                                                           maxFractionDigits="2" value="${unpaidOrders.orderBill.serviceChargeAmt}" />
                                                                     </div>
                                                                     <br />
                                                                  </c:if>
                                                               </c:if>
               ...
               <div class="modal fade" data-backdrop="static"
                  id="alertunpaidorderModalBiggerFromDate" tabindex="-1"
                  ...
                  <div class="modal-dialog" style="margin: 100px auto;">
                     <div class="modal-content"
                        ...
                        <div class="modal-body"
                           style="background: #404040; border-top: 1px solid #404040; color: #fff;">
                           <div style="text-align: center; font-size: 20px;">
                              <spring:message code="admin.rpt_cat_sales.jsp.cont_three"
                                 text="Given From Date is Greater than To Date!" />
                           </div>
                        </div>
                        <div class="modal-footer"
                           style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
                           <button type="button"
                              onclick="javascript:showCurrentDateUnpaidOrders()"
                              style="background: #72BB4F; font-weight: bold;"
                              data-dismiss="modal" class="btn btn-success">
                              <spring:message code="unpaidorder.jsp.OK" text="OK" />
                           </button>
                        ...
                        <div class="modal-header"
                           ...
                           <h4 class="modal-title"
                              ...
                              <span
                                 style="float: right;">
                                 <spring:message
                                    code="order.jsp.TABLENO" text="TABLE NO:" />
                                 <span
                                    id="cashmodTabCont">00</span>
                              </span>
                           </h4>
                        </div>
                        <div class="modal-body"
                           ...
                           <div>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6" style="float: right;">
                                 ...
                                 <div style="text-align: left; font-size: 15px; font-family: sans-serif;">
                                         <b><span id="cashtableNoValue2100"></span></b>
                                        </div>
                              </div>
                           </div>
                        ...
                        <div>
                           <table style="height: 50px; width: 100%;">
                              ...
                              <tr id="totalServiceTax_2100px">
                                 ...
                                 <td style="font-size: 14px; font-family: sans-serif;display:none;"><span
                  ...
                  <div class="modal-dialog" style="margin: 100px auto;">
                     <div class="modal-content"
                        ...
                        <div class="modal-footer"
                           style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
                           <button type="button"
                              onclick="javascript:paymentDonePeriodWise()"
                              style="width: 25%; background: #72BB4F; font-weight: bold;"
                  ...
                  <div class="modal-dialog" style="width: 276px; height: auto;">
                     <div class="modal-body" id="printDiv80"
                        ...
                        <div
                           ...
                           <b>
                              <font style="font-size: 18px; font-style: inherit; font-family: sans-serif;">
                  ...
                  <div class="modal-dialog" style="margin: 100px auto;">
                     <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                        ...
                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                           <div align="center" style=";font-size: 20px;">
                              <div style="padding: 5px;">
                                 <spring:message code="admin.creditsale.jsp.amtToPay" text="AMOUNT TO PAY" />
                                 :&nbsp;&nbsp;&nbsp;<span id="bulk_payment_total_amt_to_pay">0.00</span> 
                              </div>
                              <div style="padding: 3px;">
                                 <spring:message code="admin.creditsale.jsp.tndAmt" text="TENDER AMOUNT" />
                                 :&nbsp;<input type="text" onkeyup="javascript:bulkpay_saleChangeAmt(this.value)"  value="" id="bulkpay_salecashtenderAmt" style="text-align:center; color: #222222" size="4" onkeydown="numcheck(event);"/> 
                              </div>
                              <div style="padding: 5px;">
                                 <spring:message code="admin.creditsale.jsp.changeAmt" text="CHANGE AMOUNT" />
                                 :&nbsp;<span id="bulkpay_salecashchangeamtcontId">0.00</span> 
                              </div>
                              <div style="text-align: center;color: #F60;font-size: 12px;font-weight: bold;" id="bulk_payalertMsg"></div>
                              <input type="checkbox" id="CardPayment" class="cardpayment" onclick="javascript:accessCardPaymentDiv(this)">
                              <spring:message code="admin.creditsale.jsp.card" text="CARD" />
                        ...
                        <div class="modal-footer" style="background: #404040;border-top: 1px solid #404040;padding: 10px;">
                           <a href="javascript:bulk_payment('cash')" class="btn btn-success">
                              <spring:message code="admin.unpaidorder.bulkpay.cashpay" text="CASH PAY" />
                           </a>
                           &nbsp;
                           <a href="javascript:bulk_payment('card')" class="btn btn-success">
                              <spring:message code="admin.unpaidorder.bulkpay.cardpay" text="CARD PAY" />
                           </a>
                           &nbsp;
      ...
      <script type="text/javascript">
         ...
         var fromSpecificDate = "${fromSpecificDate}";
         var toSpecificDate = "${toSpecificDate}";
         ...
         function showalertunpaidorderModalBiggerFromDate() {
         	$('#alertunpaidorderModalBiggerFromDate').modal('show');
         }
