...
<body>
                                    	...
                                    	<c:if test="${! empty vendorList }">
                                    		<c:forEach items="${vendorList}" var="vendor">
                                    			<tr style="background:#404040; color:#FFF;">
                                    				...
                                    				<td>${vendor.name}</td>
                                    				<td align="center"><a href="javascript:showvendoreditModal(${vendor.id},&quot;${vendor.name}&quot;,&quot;${vendor.code}&quot;,&quot;${vendor.description}&quot;,&quot;${vendor.rating}&quot;,&quot;${vendor.contactNo}&quot;,&quot;${vendor.address}&quot;,&quot;${vendor.type}&quot;,&quot;${vendor.createdBy}&quot;,&quot;${vendor.accountNumber}&quot;,${vendor.creditLimit})"> <input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_edit.png"></a></td>
                                            		...
                                            		<td align="center"><a href="javascript:showDetailVendorModal(${vendor.id},&quot;${vendor.name}&quot;,&quot;${vendor.code}&quot;,&quot;${vendor.description}&quot;,&quot;${vendor.rating}&quot;,&quot;${vendor.contactNo}&quot;,&quot;${vendor.address}&quot;,&quot;${vendor.type}&quot;,&quot;${vendor.accountNumber}&quot;,${vendor.creditLimit})"><input type="image" src="${pageContext.request.contextPath}/assets/images/admin/g/g_details.png"></a></td>
                                    			</tr>
                                    		</c:forEach>
                                    	</c:if>
                                        <c:if test="${empty vendorList}">
                                    ...
                                    <div class="modal-content" style="border: 3px solid #ffffff;border-radius: 0px;">
                                        ...
                                        <div class="modal-body" style="background: #404040;border-top: 1px solid #404040;color: #fff;">
                                        	<div style="text-align: left;font-size: 20px;">
                                            	<table>
                                            		<tr>
                                            			<td><spring:message code="admin.vendormgnt.jsp.vndrName" text="vndrName" /><span style="color: #ff0000;">*</span></td>
                                            			<td>:</td>
                                            		...
                                            		<tr>
                                            			...
                                            			<td>:</td>
                                            			<td><input type="text" id="addvendorcontactContId" onkeydown="numcheck(event);" style="text-align:left; width:95%; color: #222222;margin-bottom: 5px;" /></td>
                                            		</tr>
                                            		<tr>
                                            		...
                                            		<tr>
                                            			<td>
                                                         <c:if test="${sessionScope.loggedinStore.gstText.length()!=0}">
                                                            ${sessionScope.loggedinStore.gstText}
                                                          </c:if>
                                                          <c:if test="${sessionScope.loggedinStore.gstText.length()==0}">
                                                         <spring:message code="admin.vendormgnt.jsp.trn" text="TRN NO" />
                                                         
                                                         </c:if>
                                                         
                                                         </td>
                                            			<td>:</td>
                                            			<td><input type="text" id="addvendoraccountnoContId" style="text-align:left; width:95%; color: #222222;margin-bottom: 5px;" /></td>
                                            		</tr>
                                            		...
                                            		<tr>
                                            			<td><spring:message code="admin.storecustmgnt.jsp.creditLimmit" text="CREDIT LIMIT" /></td>
                                            			<td>:</td>
                                            			<td><input type="text" id="addvendorcreditlimitContId" onkeydown="numcheck(event);" style="text-align:left; width:95%; color: #222222;margin-bottom: 5px;" /></td>
                                            		</tr>
                                        	...
                                        	<!-- <input type="hidden" id="editvendorcreateddateContId" value=""> -->
                                            	<table>
                                            		...
                                            		<tr>
                                            			...
                                            			<td>:</td>
                                            			<td><input type="text" id="editvendoraccountnoContId" style="text-align:left; width:95%; color: #222222;margin-bottom: 5px;" /></td>
                                            		</tr>
                                            		<tr>
                                            			<td><spring:message code="admin.vendormgnt.jsp.vendrType" text="VENDOR TYPE" /><span style="color: #ff0000;">*</span></td>
                                            			<td>:</td>
                                            		...
                                            		<tr>
                                            			<td><spring:message code="admin.storecustmgnt.jsp.creditLimmit" text="CREDIT LIMIT" /></td>
                                            			<td>:</td>
                                            			<td><input type="text" id="editvendorcreditlimitContId" style="text-align:left; width:95%; color: #222222;margin-bottom: 5px;" /></td>
                                            		</tr>
                                            	</table>
                                        	...
                                        	<div align="center" style="font-size: 20px;">
                                            	<table>
                                            		...
                                            		<tr>
                                            			...
                                            			<td>:</td>
                                            			<td id="moddetailvendoraccountnoTd"></td>
                                            		</tr>
                                            		...
                                            		<tr>
                                            			<td style="padding: 5px 0px;"><spring:message code="admin.storecustmgnt.jsp.creditLimmit" text="CREDIT LIMIT" /></td>
                                            			<td>:</td>
                                            			<td id="moddetailvendorcreditlimit"></td>
                                            		</tr>
                                    			</table>
   ...
   function showvendoreditModal(id,name,code,desc,rating,contact,address,type,crby,accno,creditlimit)
	{
	   	...
	   	document.getElementById('editvendoraccountnoContId').value=accno;
	   	document.getElementById('editvendorcreditlimitContId').value=creditlimit;
   ...
   function showDetailVendorModal(id,name,code,desc,rating,contact,address,type,accno,creditlimit)
   {
	   ...
	   document.getElementById('moddetailvendoraccountnoTd').innerHTML=accno;
	   document.getElementById('moddetailvendorcreditlimit').innerHTML=creditlimit;
