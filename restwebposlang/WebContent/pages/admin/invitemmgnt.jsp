						...
						<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
							<div align="center" style="font-size: 20px;">
								<table>
									...
									<tr>
										<td style="padding: 5px 0px;"><spring:message code="admin.invitemmgnt.jsp.itemCode" text="ITEM CODE" /></td>
										<td width="5%">:</td>
									...
									<tr>
										<td style="padding: 5px 0px;"><spring:message code="admin.invitemmgnt.jsp.rate" text="RATE" /></td>
										<td width="5%">:</td>
