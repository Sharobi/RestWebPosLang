                ...
                <input type="hidden" id="service_charge_codef" value="<spring:message code="accgroup.jsp.service_charge" text="SC" />">
				 ...
				 <input type="hidden" id="service_charge_ledger_idf" value="0">
					...
					<a href="javascript:bulkPay(${sessionScope.loggedinUser.storeId})"
						...
						<spring:message code="order.jsp.PAY" text="PAY" /></a> 
					</div>
																	...
																	<div class="table-responsive"
																		...
																		<table class="table table-striped table-bordered">
																			<thead>
																				...
																				<th style="text-align: center;"><spring:message code="order.jsp.NAME" text="NAME" /></th>
																		...
																		<input type="hidden" id="printbillpapersize" value="${sessionScope.loggedinStore.printBillPaperSize}">
																			...
																			<a  href="javascript:openCashModal(${totPrice},${netPrice},${netTotal})"
																			...
																			</a> <a href="javascript:openCardModal(${totPrice},${netPrice},${netTotal})"
																				class="btn-order-taking"
																				style="text-align: center; width: 30%;"> <span
																				class="fa fa-credit-card"></span>&nbsp;<spring:message
																					code="order.jsp.CARD" text="CARD" />
																			</a> <a href="javascript:openOnlineModal(${totPrice},${netPrice},${netTotal})"
																				class="btn-order-taking"
									...
									<table
										...
										<thead>
											...
											<tr>
												...
												<td></td>
												<td></td>
												<c:if test="${sessionScope.loggedinStore.serviceChargeFlag=='Y'}"><td></td>  </c:if>
												<td></td>
												<th width="5%;"><spring:message
