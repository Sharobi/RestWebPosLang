			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					...
					<div class="col-md-12 col-sm-12" style="background-color: #999;">
						...
						<div class="col-md-7 col-sm-7">
							<div class="inv-requisition-0">
								<spring:message code="rm.fgstockin.jsp.date" text="DATE" /> <input type="text" disabled="disabled" id="" size="8" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${today}" />"> &nbsp;&nbsp; <spring:message code="rm.fgstockin.jsp.edpId" text="EDP ID" /> <input type="text" id="clickededpid" disabled="disabled" size="5" value="0"> &nbsp;&nbsp; <spring:message code="rm.fgstockin.jsp.fgId" text="FG ID" /> <input type="text" id="clickedfgid" disabled="disabled" size="5" value="0">
							</div>
						</div>
					</div>
					<div class="col-md-12 col-sm-12" style="background: #CCCCCC;">
						<div class="col-md-3 col-sm-3">
							<div>
								<form modelAttribute="estimateDailyProd" action="${pageContext.request.contextPath }/fgstockin/getfgstockinbydateandstoreid.htm" method="post">
									<div class="col-md-12 col-sm-12">
										<div class="col-md-3 col-sm-3" style="padding: 3px; font-weight: bold;"><spring:message code="rm.fgstockin.jsp.date" text="DATE :" /></div>
									...
									<table id="recipeingredientlist" class="table table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr style="background-color: #77C5EB">
												...
												<th><spring:message code="rm.fgstockin.jsp.remarks" text="REMARKS" /></th>
												<th><spring:message code="rm.fgstockin.jsp.eiItem" text="EIITEM" /></th>
												<th><spring:message code="rm.fgstockin.jsp.ciItem" text="CIITEM" /></th>
											</tr>
										</thead>
										    ...
										    <c:if test="${!empty edpList}">
												<c:forEach items="${edpList}" var="edplist" varStatus="status">
													<c:if test="${edplist.approved =='Y'}">
												      <c:if test="${edplist.fgStockInStatus =='Y'}">
													<tr style="cursor: pointer; background-color: #c8e6f0;" class="selected-stockin-row" onclick="rowClicked(${edplist.id},${edplist.fgStockInId},&quot;${edplist.fgStockInStatus}&quot;)">
															<td>${edplist.id}</td>
															<td style="word-break: break-all;">${edplist.estimateType.name}</td>
															<td>${edplist.totalEstimatedQty}</td>
															<td>${edplist.totalStockInQty}</td>
														</tr>
													  </c:if> 
													 <c:if test="${edplist.fgStockInStatus !='Y'}">
													<tr style="cursor: pointer; background-color: #ffffcc;" class="selected-stockin-row" onclick="rowClicked(${edplist.id},${edplist.fgStockInId},&quot;${edplist.fgStockInStatus}&quot;)">
															<td>${edplist.id}</td>
															<td style="word-break: break-all;">${edplist.estimateType.name}</td>
															<td>${edplist.totalEstimatedQty}</td>
															<td>${edplist.totalStockInQty}</td>
						...
						<div class="col-md-9 col-sm-9">
							<div class="col-md-3 col-sm-3">
								...
								<spring:message code="rm.fgstockin.jsp.cat" text="Category :" />  	<select name="selectedmenucategoryName" id="selectedmenucategoryName" class="selectedmenucategory" onchange="getSelectedCat()">
										<option value="Select All"><spring:message code="rm.fgstockin.jsp.slctAll" text="Select All" /></option>
									...
									</select> <input type="hidden" class="text-input" id="filterbycat" placeholder="<spring:message code="rm.fgstockin.jsp.srchByItemName" text="Item Search by Name..." />" value="" style="width: 90%; margin-top: 2%;" />
								</div>
							</div>
							<div class="col-md-3 col-sm-3">
								<input type="text" class="text-input" id="filter" placeholder="<spring:message code="rm.fgstockin.jsp.srchByItemName" text="Item Search by Name..." />" value="" style="width: 90%; margin-top: 2%;" />
							</div>
						...
						<div class="col-md-9 col-sm-9">
							<div style="height: 365px; overflow-y: auto; background-color: #fff;">
								<table class='table table-bordered header-fixed' id="saverecipe" style='border: 1px solid #fff;'>
									<thead style="background-color: #999;">
										<th style='text-align: center;'><spring:message code="rm.fgstockin.jsp.id" text="ID" /></th>
										<th style='text-align: center;'><spring:message code="rm.fgstockin.jsp.cat" text="CAT" /></th>
										<th style='text-align: center;'><spring:message code="rm.fgstockin.jsp.subCat" text="SUB CAT" /></th>
										<th style='text-align: center;'><spring:message code="rm.fgstockin.jsp.fdItem" text="FOOD ITM" /></th>
										<th style='text-align: center;'><spring:message code="rm.fgstockin.jsp.estQty" text="ESTIMATED QTY" /></th>
...
<!-- 										<th style='text-align: center;'>ACTION</th> -->
							...
							<div align="center" id="savefgstockin">
								<div class="col-md-4 col-sm-4 hide">
									<spring:message code="rm.fgstockin.jsp.changePW" text="CHANGE" />Misc Charges:<input type="text" size="10" id="misChargeId" onkeyup="javascript:calculateGrandTotal()" value='<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" groupingUsed="false" value="0.00"/>' style="text-align: right;"> &nbsp; <a href="javascript:poOrderPrint()" class="btn btn-success hide" style="background: #78B626; margin-top: 3px;"><spring:message code="rm.fgstockin.jsp.print" text="PRINT" /></a>
								<font style="font-weight: bold;"><spring:message code="rm.fgstockin.jsp.changePW" text="CHANGE" />GRAND TOTAL:</font><input type="hidden" id="grandtotalId" name="totalId" size="10" value='<fmt:formatNumber type="number" groupingUsed="false" minFractionDigits="2" maxFractionDigits="2" value="0.00"/>' style="text-align: right;" readonly="readonly"> &nbsp;
								</div>
								<div class="col-md-4 col-sm-4"></div>
								<div class="col-md-4 col-sm-4">
									 <a href="javascript:fgstockinSave()" id="fgstockinSave" class="btn btn-success" style="background: #78B626; margin-top: 3px;"><spring:message code="rm.fgstockin.jsp.save" text="Save" /></a>
								</div>
	...
	<div class="modal fade" data-backdrop="static" id="fgsuccessdmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content" style="border: 3px solid #ffffff; border-radius: 0px;">
				...
				<div class="modal-body" style="background: #404040; border-top: 1px solid #404040; color: #fff;">
					<div style="text-align: center; font-size: 20px;"><spring:message code="rm.fgstockin.jsp.fgStkSucSave" text="FG stockin successfully saved." /></div>
				</div>
				<div class="modal-footer" style="background: #404040; border-top: 1px solid #404040; padding: 10px;">
					<button type="button" onclick="javascript:saveFGStockin()" style="font-weight: bold; width: 25%;" class="btn btn-success" data-dismiss="modal"><spring:message code="rm.fgstockin.jsp.ok" text="OK" /></button>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="${pageContext.request.contextPath}/assets/js/rm/fgstockinScript.js"></script>
