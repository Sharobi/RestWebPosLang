...
<!--[if IE]>
        ...
        <![endif]-->
<title>:. POS :: Fg Stock Display :.</title>
			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
				    <%-- <spring:message code="rmleftpanel.jsp.FGSimpleStockInDispalySearchByItm" text="Enter Item Name For Search:" /> --%>
						...
						<div class="col-md-2 col-sm-2">
							<div class="inv-requisition-0" style="font-size: 18px;"><spring:message code="rmleftpanel.jsp.FGSimpleStockInDispaly" text="FG STOCK DISPLAY"/></div>
						...
						<input type="text" class="text-input" id="filter" placeholder="Item Search by Name..." value="" style="width: 100%; margin-top: 10px;margin-bottom: 3px" />
							...
							<div align="center" id="savefgstockin">
								...
								<span id="operationbtnspan"></span>
									<a href="javascript:" id="fgstockinExport" class="btn btn-success" style="background: #78B626; margin-top: 3px;"><spring:message code="invitemstock.jsp.export" text="EXPORT" /></a> 
								</div>
							</div>
				</div>
			</div>
