...
<!--[if IE]>
        ...
        <![endif]-->
<title>:. POS :: Manual StockOut :.</title>
...
<body>
	...
	<div class="content-wrapper">
					...
					<div class="menu-category">
						<div style="padding: 8px;">
							...
							<c:when test="${sessionScope.loggedinStore.validateRawStockOut=='N'}">
								<div class="item item-sub-child" style="background-color: #72bb4f;">
								<a href="#"><spring:message code="inventorynew.jsp.SIMPLESTOCKOUT" text="SIMPLE STOCK OUT" /></a>
								</div>
							</c:when>
							<c:otherwise>
								<div class="item item-sub-child" style="background-color: #72bb4f;">
								<a href="#"><spring:message code="inventorynew.jsp.SIMPLESTOCKOUTMAN" text="SIMPLE STOCK OUT MANUAL" /></a>
							</div>
							</c:otherwise>
							</c:choose>
							<div class="item item-sub-child" style="background-color: #72bb4f;">
				...
				<div class="col-md-10 col-sm-10" style="background-color: #999;">
					...
					<div class="col-md-12 col-sm-12" style="background: #CCCCCC;height: 450px;">
						...
						<div class="col-md-6" style="text-align:center;">
						     ...
						     <a href="javascript:stockOutDeleteConfirmation()"
								id="stockOutDelete" class="btn btn-success"
								style="background: #78B626; margin-top: 3px;"><spring:message
									code="inventorynew.jsp.Delete" text="Delete" /></a> <a
								href="javascript:approveStockOut()" id="stockOutApprove"
								class="btn btn-success"
								style="background: #78B626; margin-top: 3px;"><spring:message
									code="inventorynew.jsp.APPROVE" text="Approve" /></a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="modal fade" data-backdrop="static" id="stockoutdeletemodal"
		...
		<div class="modal-dialog" style="margin: 100px auto;">
			<div class="modal-content"
				...
				<div class="modal-footer"
					...
					<button type="button" onclick="javascript:stockOutDelete()"
	...
	<script src="${pageContext.request.contextPath}/assets/js/stockoutScriptMan.js"></script>
