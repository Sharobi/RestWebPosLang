...
function showpdfrptpaymentmodeSales(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_day_sale+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
...
function showpdfrptdaywiseSales(fromdate, todate, storeId, rptType) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_day_sale+"?date="+date+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		// var pdfline="<iframe
		// src='"+pdf_url_day_sale+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
...
function showpdfrptdaytimewiseSales(fromdate, todate, storeId, workingHour,
		rpttype) {
	var todaydate = document.getElementById('hiddenrptdaywiseSales').value;
	// alert("form date:"+fromdate+" "+"todate:"+todate +"
	// "+"curdate:"+todaydate);
	if (dateformat(fromdate) > dateformat(todaydate)) {
		showalertrptsalesdayModal1();
		return;
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_day_time_sale+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"&workingHours="+workingHour+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_day_time_sale
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptperiodwiseSales(fromdate, todate, type, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_period_sale+"?type="+type+"&frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_period_sale
				+ "?type="
...
function showpdfrptuserwiseSales(fromdate, todate, storeId, userId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_user_day_sale+"?date="+date+"&storeId="+storeId+"&user="+userId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		// var pdfline="<iframe
		// src='"+pdf_url_user_day_sale+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"&user="+seluser+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_user_day_sale
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptdaywisehourlySales(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_day_wise_hourly_sale+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_day_wise_hourly_sale
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptperiodwisesummarySales(fromdate, todate, storeId) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_period_wise_summary_sale
				+ "?startDate="
				+ fromdate
				+ "&endDate="
				+ todate
...
function showpdfrptitemwisedailyOrder(date, storeId, rpttype) {
	...
	if (dateformat(date) > dateformat(todaydate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_item_wise_day_order+"?date="+date+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_item_wise_day_order
				+ "?date="
				+ date
				+ "&storeId="
				+ storeId
...
function showpdfrptitemwiseperiodOrder(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_item_wise_period_order+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_item_wise_period_order
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptorderswithdeliveryboys(fromdate, todate, storeId, rpttype,
		deliveryboyid) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		/*
		 * var pdfline="<iframe
		 * src='"+pdf_url_orders_with_deliveryboys_list+"?storeId="+storeId+"&orderFrom="+fromdate+"&orderTo="+todate+"&deliveryBoyId="+deliveryboyid+"&catId="+catid+"&rptType="+rpttype+"'
		 * style='width:100%; height:450px;' frameborder='0'></iframe>";
		 */
		var pdfline = "<iframe src='"
				+ pdf_url_orders_with_deliveryboys_list
				+ "?storeId="
				+ storeId
				+ "&orderFrom="
				+ fromdate
...
function showpdfrptcatdaywiseSales(date, ktype, storeId, rpttype) {
	...
	if (dateformat(date) > dateformat(todaydate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_day_sale_cat+"?date="+date+"&storeId="+storeId+"&category="+ktype+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_day_sale_cat
				+ "?date="
				+ date
				+ "&storeId="
				+ storeId
...
function showpdfrptperiodwisecreditSales(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_period_credit_sale+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_period_credit_sale
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptperiodwisecancelOrder(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_period_wise_cancel_order+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_period_wise_cancel_order
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptperiodwisenockotOrder(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_period_wise_nockot_order+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_period_wise_nockot_order
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptdaywisePo(date, storeId, rpttype) {
	...
	if (dateformat(date) > dateformat(todaydate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_day_po+"?date="+date+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_day_po
				+ "?date="
...
function showpdfrptperiodwiseStockIn(fromdate, todate, type, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_period_stockin+"?type="+type+"&frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_period_stockin
				+ "?type="
				+ type
				+ "&frmdate="
				+ fromdate
...
function showpdfrptdaywiseStockIn(date, storeId, rpttype) {
	...
	if (dateformat(date) > dateformat(todaydate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_day_stockin+"?date="+date+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_day_stockin
				+ "?date="
...
function showpdfrptperiodwiseStockOutallCat(fromdate, todate, type, storeId,
		rpttype) {

	var todaydate = document
			.getElementById('hiddaterptperiodwiseStockOutallCat').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_period_stockout_allcat
				+ "?type="
				+ type
				+ "&frmdate="
				+ fromdate
...
function showpdfrptperiodwiseStockOutKitchen(fromdate, todate, type, storeId,
		ktype, rpttype) {
	var todaydate = document
			.getElementById('hiddaterptperiodwiseStockOutKitchen').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_period_stockout_kitchen
				+ "?type="
				+ type
				+ "&frmdate="
				+ fromdate
...
function showpdfrptcustomerlist(rpttype, storeid) {
	...
	var pdfline = "<iframe src='" + pdf_url_customer_list + "?storeId="
			+ storeid + "&rptType=" + rpttype
			+ "' style='width:100%; height:450px;' frameborder='0'></iframe>";
	document.getElementById('customerListReportContainer').innerHTML = pdfline;

}
function showpdfoutstandingcust(storeid, rpttype) {
	var pdfline = "<iframe src='" + pdf_url_outstanding_customer_list
			+ "?storeId=" + storeid + "&rptType=" + rpttype
			+ "' style='width:100%; height:450px;' frameborder='0'></iframe>";
...
function showpdfrpttopcustomerlist(storeid, rpttype) {
	...
	var pdfline = "<iframe src='" + pdf_url_top_customer_list + "?storeId="
			+ storeid + "&rptType=" + rpttype
			+ "' style='width:100%; height:450px;' frameborder='0'></iframe>";
...
function showpdfrptnewrepeatcustomer(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_new_repeat_customer_list
				+ "?storeId="
				+ storeId
				+ "&orderFrom="
				+ fromdate
...
function showpdfrptcancelorderscelavi(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_report_cancelorderreason
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptdailymanagertaxcelavi(fromdate, todate, storeId) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_report_dailymanagerwithtax
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptdailysalesinclusivecelavi(fromdate, todate, storeId, rpttype) {
	var todaydate = document
			.getElementById('hiddaterptdailysalesinclusivecelavi').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_report_dailysalesinclusive
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptdailysalessummary(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_report_dailysalessummary
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptcatwiseperiodicSales(fromdate, todate, ktype, storeId,
		rpttype) {
	var todaydate = document.getElementById('hiddaterptcatdaywiseSales').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
		showalertrptcatsalesdayModal();
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_day_sale_cat+"?date="+fromdate+"&date1="+todate+"&storeId="+storeId+"&category="+ktype+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_day_sale_cat
				+ "?date="
...
function showpdfrptplstatement(fromdate, todate, storeId) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_accounts_periodic_pl_statement
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrpttaxstatement(fromdate, todate, storeId) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		var pdfline = "<iframe src='"
				+ pdf_url_accounts_periodic_tax_statement
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptrefunddetails(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_refunds_periodic_refund_details+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_refunds_periodic_refund_details
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showpdfrptrefundsummary(fromdate, todate, storeId, rpttype) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_refunds_periodic_refund_summary+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_refunds_periodic_refund_summary
				+ "?frmdate="
				+ fromdate
				+ "&todate="
				+ todate
...
function showPdfRptRawStockinRegister(fromdate, todate, vendor, storeId,
		rpttype) {
	var todaydate = document.getElementById('rpthiddate').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
		showalertrptperiodModal();
...
function showPdfRptRawStockoutSummary(fromdate, todate, vendor, storeId,
		rpttype) {
	var todaydate = document.getElementById('rpthiddate').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
		showalertrptperiodModal();
...
function showPdfRptRawStockoutRegister(fromdate, todate, vendor, storeId,
		rpttype) {
	var todaydate = document.getElementById('rpthiddate').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
		showalertrptperiodModal();
...
function showPdfRptFgStockoutRegister(fromdate, todate, vendor, storeId,
		rpttype) {
	var todaydate = document.getElementById('rpthiddate').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
		showalertrptperiodModal();
...
function showpdfrptperiodicVendorPayment(fromdate, todate, storeId, rpttype,
		vendorid) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_periodic_vendor_payment+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"&rptType="+rpttype+"&vendorId="+vendorid+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_periodic_vendor_payment
				+ "?storeId="
				+ storeId
				+ "&frmdate="
				+ fromdate
...
function showpdfrptperiodicFgVendorPayment(fromdate, todate, storeId, rpttype,
		vendorid) {
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_periodic_fgvendor_payment
				+ "?storeId="
				+ storeId
				+ "&frmdate="
				+ fromdate
...
function showpdfrpttableorderswithwaiter(fromdate, todate, storeId, rpttype) {
	var todaydate = document.getElementById('hiddaterptperiodwisePo').value;
	if (dateformat(fromdate) > dateformat(todaydate)) {
		showalertrptpoperiodModal();
		return;
	...
	if (dateformat(fromdate) > dateformat(todate)) {
		...
		// var pdfline="<iframe
		// src='"+pdf_url_tableorders_with_waiter_list+"?storeId="+storeId+"&orderFrom="+fromdate+"&orderTo="+todate+"'
		// style='width:100%; height:450px;' frameborder='0'></iframe>";
		var pdfline = "<iframe src='"
				+ pdf_url_tableorders_with_waiter_list
				+ "?storeId="
				+ storeId
				+ "&orderFrom="
				+ fromdate
...
function showpdfrptroomreservedetails(fromdate,todate,storeId,bookingtype,rpttype){
	var todaydate=document.getElementById('hiddaterptrefunddetails').value;
	if(dateformat(fromdate)>dateformat(todaydate))
	{
	showalertrptrefunddetailsperiodModal();
	...
	var pdfline="<iframe src='"+pdf_url_roombooking_reserve_details+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"&rptType="+rpttype+"&bookingType="+bookingtype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";	
	document.getElementById('roomreservedetailsreportContainerId').innerHTML=pdfline;
	}
}

function showpdfrptroombookingdetails(fromdate,todate,storeId,bookingtype,rpttype){
	var todaydate=document.getElementById('hiddaterptrefunddetails').value;
	if(dateformat(fromdate)>dateformat(todaydate))
	{
	showalertrptrefunddetailsperiodModal();
	...
	var pdfline="<iframe src='"+pdf_url_roombooking_booking_details+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"&rptType="+rpttype+"&bookingType="+bookingtype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";	
	document.getElementById('roombookingdetailsreportContainerId').innerHTML=pdfline;
	}
	}

function showpdfrptroompaymentwisesaledetails(fromdate,todate,storeId,rpttype){
	var todaydate=document.getElementById('hiddendate').value;
	if(dateformat(fromdate)>dateformat(todaydate))
	{
	showalertrptrefunddetailsperiodModal();
	return;
	...
	var pdfline="<iframe src='"+pdf_url_roombooking_paymentwisesale_details+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";	
	document.getElementById('roompaymentwisesalreportContainerId').innerHTML=pdfline;
	}
}

function showpdfguestlistreport(fromdate,todate,storeId,rpttype){
	var todaydate=document.getElementById('hiddendate').value;
	if(dateformat(fromdate)>dateformat(todaydate))
	{
	showalertrptrefunddetailsperiodModal();
	...
	var pdfline="<iframe src='"+pdf_url_rpt_guestlist+"?frmdate="+fromdate+"&todate="+todate+"&storeId="+storeId+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";	
	//alert("PDFLINE IS:"+pdfline)
	document.getElementById('guestListContainerId').innerHTML=pdfline;
	}
}


function showflashreport(fromdate,storeId,rpttype){
	var todaydate=document.getElementById('hiddendate').value;
	/*if(dateformat(fromdate)>dateformat(todaydate))
	{
	showalertrptrefunddetailsperiodModal();
	...
	var pdfline="<iframe src='"+pdf_url_rpt_flashreport+"?frmdate="+fromdate+"&storeId="+storeId+"&rptType="+rpttype+"' style='width:100%; height:450px;' frameborder='0'></iframe>";	
	//alert("PDFLINE IS:"+pdfline)
	document.getElementById('flashReportContainerId').innerHTML=pdfline;
	/*}*/
}
