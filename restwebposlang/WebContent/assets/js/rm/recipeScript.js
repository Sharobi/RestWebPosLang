...
function prepareHtml(reponseObj) {
	...
	for ( var i = 0; i < reponseObj.length; i++) {
		...
		firsttdline = "<td align='center' style='padding:1px;'><input type='text' size='4' onkeyup=javascript:changeMetricAmt(this.value," + orderitem.inventoryItem.id + "," + orderitem.inventoryItem.id + ") id='itmmetricAmount_" + orderitem.inventoryItem.id + "' value='" + orderitem.metricAmount + "' /></td>";
		...
		var endtrline = "</tr>";
		createdrowline += begintrline + firsttdline + secondtdline + thirdtdline + fourthtdline + fifthtdline + sixtdline + endtrline;
...
function addNewItem() {
	...
	if (itemid != '') {
		...
		if (itempresent == 1) {
			...
			firsttdline = "<td align='center' style='padding:1px;'><input type='text' size='4' onkeyup=javascript:changeMetricAmt(this.value," + itemid + "," + itemid + ") id='itmmetricAmount_" + itemid + "' value='1.0' /></td>";
			...
			var fourthtdline = "<td  style='padding:1px;text-align: center;'><input type='text' size='4' onkeyup=javascript:changeCookingAmt(this.value," + itemid + "," + itemid + ") id='itmcookingAmount_" + itemid + "' value='1.0' /></td>";
			...
			var endtrline = "</tr>";
			var createdrowline = begintrline + firsttdline + secondtdline + thirdtdline + fourthtdline + fifthtdline + sixtdline + endtrline;
