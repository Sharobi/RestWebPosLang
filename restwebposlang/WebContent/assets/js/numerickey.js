$(document).ready(function(){
     /* $('#cashtenderAmt').click(function(){
      ...
      $('#done').click(function(){
          //$('#n_keypad').hide('fast');
    	  $('#cashtenderAmt').val($('#cashamttopaycontId').text());
        ...
        if (!isNaN($('#cashtenderAmt').val())) {
           if (parseInt($('#cashtenderAmt').val()) == 0) {
             $('#cashtenderAmt').val($(this).text());
        	   ...
        	   /*if(checkDecimal($('#cashtenderAmt').val()))
        		   {
        		   $('#cashtenderAmt').val($('#cashtenderAmt').val() + $(this).text());
        		   }
        	   else{
        		   $('#cashtenderAmt').val(Number(Number($('#cashtenderAmt').val()) +Number( $(this).text())));  
        	   	}*/
      ...
      $('#numero200').click(function(){
          if (!isNaN($('#cashtenderAmt').val())) {
             if ($('#cashtenderAmt').val() == '') {
               $('#cashtenderAmt').val(200);
             } else {
               $('#cashtenderAmt').val(parseFloat($('#cashtenderAmt').val()) + 200);
             }
             getChangeAmt($('#cashtenderAmt').val());
          }
        });
      $('#numero100').click(function(){
          if (!isNaN($('#cashtenderAmt').val())) {
             if ($('#cashtenderAmt').val() == '') {
               ...
               $('#cashtenderAmt').val(parseFloat($('#cashtenderAmt').val()) + 100);
             }
             getChangeAmt($('#cashtenderAmt').val());
          }
        });
      $('#numero50').click(function(){
          if (!isNaN($('#cashtenderAmt').val())) {
             if ($('#cashtenderAmt').val() == '') {
               ...
               $('#cashtenderAmt').val(parseFloat($('#cashtenderAmt').val()) + 50);
             }
             getChangeAmt($('#cashtenderAmt').val());
          }
        });
      $('#numero20').click(function(){
          if (!isNaN($('#cashtenderAmt').val())) {
             if ($('#cashtenderAmt').val() == '') {
               ...
               $('#cashtenderAmt').val(parseFloat($('#cashtenderAmt').val()) + 20);
             }
             getChangeAmt($('#cashtenderAmt').val());
          }
        });
      $('#numero10').click(function(){
          if (!isNaN($('#cashtenderAmt').val())) {
             if ($('#cashtenderAmt').val() == '') {
               ...
               $('#cashtenderAmt').val(parseFloat($('#cashtenderAmt').val()) + 10);
             }
             getChangeAmt($('#cashtenderAmt').val());
          }
        });
      $('#numerorm5').click(function(){
          if (!isNaN($('#cashtenderAmt').val())) {
             if ($('#cashtenderAmt').val() == '') {
               ...
               $('#cashtenderAmt').val(parseFloat($('#cashtenderAmt').val()) + 5);
             }
             getChangeAmt($('#cashtenderAmt').val());
          }
        });
        ...
        if (!isNaN($('#cardlastfourDigit').val())) {
           if (parseInt($('#cardlastfourDigit').val()) == 0) {
             $('#cardlastfourDigit').val($(this).text());
        	   ...
        	   if($('#cardlastfourDigit').val().length!=4)
        		   {
   ...
   $('#tipsamt').click(function(){
 	  
       $('#n_keypad_cr2').fadeToggle('fast');
       $('#n_keypad_cr1').hide('fast');
       $('#n_keypad_cr').hide('fast');
   });
     ...
     $('#done_cr1').click(function(){
      ...
      //for tips amount start
      
      
      $('#done_cr2').click(function(){
          $('#n_keypad_cr2').hide('fast');
      });
      $('#numero1_cr2').click(function(){
        if (!isNaN($('#tipsamt').val())) {
           if (parseInt($('#tipsamt').val()) == 0) {
             $('#tipsamt').val($(this).text());
           } else {
             $('#tipsamt').val($('#tipsamt').val() + $(this).text());
           }
        }
      });
      $('#numero2_cr2').click(function(){
          if (!isNaN($('#tipsamt').val())) {
             if (parseInt($('#tipsamt').val()) == 0) {
               $('#tipsamt').val($(this).text());
             } else {
      ...
      $('#numerodot_cr2').click(function(){
          if (!isNaN($('#tipsamt').val())) {
             if (parseInt($('#tipsamt').val()) == 0) {
               $('#tipsamt').val($(this).text());
             } else {
               $('#tipsamt').val($('#tipsamt').val() + $(this).text().trim());
             }
          }
        });
      $('.neg_cr2').click(function(){
          if (!isNaN($('#tipsamt').val()) && $('#tipsamt').val().length > 0) {
            if (parseInt($('#tipsamt').val()) > 0) {
              $('#tipsamt').val(parseInt($('#tipsamt').val()) - 1);
            }
          }
      });
      $('.pos_cr2').click(function(){
          if (!isNaN($('#tipsamt').val()) && $('#tipsamt').val().length > 0) {
            $('#tipsamt').val(parseInt($('#tipsamt').val()) + 1);
          }
      });
      $('#del_cr2').click(function(){
          $('#tipsamt').val($('#tipsamt').val().substring(0,$('#tipsamt').val().length - 1));
      });
      $('#clear_cr2').click(function(){
          $('#tipsamt').val('');
      });
      $('#zero_cr2').click(function(){
        if (!isNaN($('#tipsamt').val())) {
          if (parseInt($('#tipsamt').val()) != 0) {
            $('#tipsamt').val($('#tipsamt').val() + $(this).text());
          }
